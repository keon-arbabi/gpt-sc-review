...
# summary for Kaufman 2021 (excitatory neurons)

<metadata>
Kaufmann M, Evans H, Schaupp A-L, et al. "Identifying CNS-colonizing T cells as potential therapeutic targets to prevent progression of multiple sclerosis." Med 2, 296–312, March 12, 2021. https://doi.org/10.1016/j.medj.2021.01.006
Disease focus: Multiple sclerosis (MS), with emphasis on relapsing-remitting (RRMS) and progressive forms (SPMS/PPMS).
</metadata>

<methods>
This study used multimodal single-cell RNA sequencing (scRNA-seq) and surface protein profiling (CITE-seq) on peripheral blood mononuclear cells (PBMCs) from MS patients (RRMS, PPMS) and matched controls, totaling 497,705 transcriptomes and 355,433 surface protein profiles. Spatial RNA sequencing was performed on post mortem brain tissue from 6 progressive MS patients and 4 controls (~85,000 spot transcriptomes). The main focus was on immune cell populations, with unsupervised clustering and integration of transcriptomic and surface marker data. Validation included spatial localization of cell signatures in brain tissue.
</methods>

<findings>
**Cell Type Proportions and Subtype Identification**
The study did not focus on excitatory neurons, but rather on immune cell populations, particularly T cells. Excitatory neurons were not a primary subject of analysis, and there is no evidence in the text or figures that excitatory neuron subtypes were systematically characterized or quantified in terms of proportion, gene expression, or disease association. The single-cell and spatial transcriptomic analyses were designed to identify and track CNS-homing immune cells, especially a pathogenic CD4+ T cell population (T09 cluster), not neuronal populations.

**Differential Gene Expression and Pathway Enrichment**
No differential gene expression, pathway enrichment, or marker gene analysis was performed or reported for excitatory neurons. The main transcriptomic signatures and pathway analyses were centered on T cell subtypes, particularly those expressing CD161 (KLRB1) and LTB, with functional signatures related to migration, adhesion, and encephalitogenicity.

**Cell Subtype Characterization**
Excitatory neurons were not subdivided or characterized in this study. The clustering and annotation of single-cell data focused on immune cell types (T cells, B cells, monocytes, NK cells, dendritic cells, plasma cells, megakaryocytes), with no mention of neuronal subtypes or states. Spatial transcriptomics was used to localize immune cell signatures (not neuronal) in MS brain tissue.

**Spatial and Morphological Findings**
Spatial transcriptomics was applied to brain tissue to localize the T09 T cell signature, not to map or analyze excitatory neurons. There is no report of morphological or spatial findings related to excitatory neurons.

**Aging/Disease Trajectories**
No temporal modeling, pseudotime, or disease progression analysis was performed for excitatory neurons. All trajectory analyses were focused on immune cell populations.

**Modulators & Metrics**
No host or genetic factors, activation scores, or morphology metrics were reported for excitatory neurons.

**Gene Regulatory Networks, Cell-Cell Communication, Genetic Integration**
No gene regulatory network, ligand-receptor, or genetic risk variant analyses were performed for excitatory neurons.

<keyFinding priority='3'>
The study did not report any significant findings regarding excitatory neurons in MS blood or brain tissue. All major findings pertain to immune cell populations, particularly CNS-homing CD4+ T cells.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
There are no disease-specific roles, mechanistic insights, or therapeutic implications discussed for excitatory neurons in this paper. The entire clinical relevance section is devoted to the identification and targeting of pathogenic T cell populations in MS.
</clinical>

---

**Quick Reference**
This study does not report any findings on excitatory neurons in multiple sclerosis. All major results concern immune cell populations, especially a pathogenic CD4+ T cell subtype (T09) with a Th17/Tfh phenotype, and their role in CNS colonization and progression of MS. No excitatory neuron subtypes, marker genes, or disease associations are described.
...
<findings>
The paper by Kaufmann et al. (2021) investigates the immune landscape of multiple sclerosis (MS) using multimodal single-cell and spatial transcriptomics, with a primary focus on identifying and characterizing CNS-homing T cells that may drive disease progression. The study integrates scRNA-seq and CITE-seq data from peripheral blood mononuclear cells (PBMCs) of MS patients (both relapsing-remitting and progressive forms) and healthy controls, as well as spatial RNA sequencing of post mortem brain tissue from progressive MS patients and controls.

The central discovery is the identification of a pathogenic CD4+ T cell population (cluster T09), characterized by high expression of CD161 (KLRB1) and lymphotoxin beta (LTB), with a hybrid Th17/Tfh phenotype. These cells are enriched in the blood of natalizumab-treated RRMS patients (where CNS entry is blocked), but depleted from the blood of untreated RRMS and progressive MS patients, suggesting their migration and residence within the CNS. Spatial transcriptomics confirms the presence of the T09 signature in both white and gray matter regions of progressive MS brains, particularly in areas associated with demyelination and disease progression.

The study provides a detailed molecular and functional characterization of the T09 population, including upregulation of migration and adhesion genes (e.g., ITGA4, AQP3, EZR), transcription factors (MAF, RORA), and other surface markers (ICOS, TNFRSF25) that may be therapeutically targetable. Pathway enrichment analyses highlight terms related to T cell migration, chemotaxis, and extravasation, supporting the role of these cells in CNS infiltration.

However, the study does not analyze or report on excitatory neurons. The single-cell and spatial transcriptomic analyses are designed to resolve immune cell heterogeneity, and the clustering, marker gene, and pathway analyses are all focused on immune cell types. There is no mention of excitatory neuron subtypes, marker genes, or disease associations in the text, figures, or supplementary materials. Spatial transcriptomics is used exclusively to track immune cell signatures, not neuronal populations.

<keyFinding priority='3'>
No significant findings are reported for excitatory neurons in this study. The absence of data or analysis on this cell type is consistent throughout the paper.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
Given the lack of data on excitatory neurons, there are no clinical or mechanistic insights, nor any therapeutic or biomarker implications, discussed for this cell type in the context of MS in this paper.
</clinical>
...
The absence of findings on excitatory neurons in this comprehensive single-cell and spatial transcriptomic study of MS highlights a gap in the current understanding of neuronal involvement in disease progression, at least from the perspective of this dataset and analysis. While the study provides a valuable resource for immune cell profiling and identifies a key pathogenic T cell population, it does not address neuronal heterogeneity, vulnerability, or response in MS. Future studies could leverage similar multimodal single-cell and spatial approaches to systematically characterize excitatory neuron subtypes, their gene expression changes, and their spatial distribution in MS brains, particularly in relation to demyelination, neurodegeneration, and immune cell infiltration. This would be essential to integrate neuronal and immune mechanisms in MS pathogenesis and progression.

<contradictionFlag>none</contradictionFlag>
No conflicts or contradictions with prior data on excitatory neurons are discussed, as the topic is not addressed in the paper.
</researchImplications>
...
# summary for Olah 2020 (excitatory neurons)

<metadata>
Olah M, Menon V, Habib N, et al. "Single cell RNA sequencing of human microglia uncovers a subset associated with Alzheimer’s disease." Nature Communications. 2020;11:6129. https://doi.org/10.1038/s41467-020-19737-2
Disease focus: Alzheimer’s disease (AD), aging brain
</metadata>

<methods>
This study used single-cell RNA sequencing (scRNA-seq) on live immune cells (primarily microglia) isolated from human cerebral cortex samples. Samples were obtained from autopsy (dorsolateral prefrontal cortex, DLPFC) of aged individuals (n=14, from the Rush Memory and Aging Project) and from surgical resections (temporal neocortex, TNC) in epilepsy patients (n=3). The 10x Genomics Chromium platform was used for scRNA-seq. Validation included immunohistochemistry and in situ quantification, as well as replication in independent single-nucleus RNA-seq datasets. The primary focus was on microglial heterogeneity; excitatory neurons were not directly isolated or profiled.
</methods>

<findings>
**Cell Type Proportions and Identification**  
Excitatory neurons were not the primary focus of this study. The cell isolation protocol was designed to enrich for live immune cells, particularly microglia, from human cortical tissue. The vast majority of sequenced cells (>99%) were myeloid (microglia/monocytes), with rare contamination by non-myeloid cells (including neurons, astrocytes, T and B cells, and erythrocytes). Excitatory neurons were not systematically captured or analyzed in this dataset.

**Excitatory Neuron Subtypes and States**  
The study does not report the identification, characterization, or subtyping of excitatory neurons. No distinct excitatory neuron clusters, marker genes, or disease-associated states for excitatory neurons are described. The clustering and downstream analyses were focused on microglial subpopulations (nine robust clusters), with only minor mention of rare non-myeloid cells detected as positive controls for the sorting and sequencing pipeline.

**Differential Gene Expression and Pathway Enrichment**  
No differential gene expression, pathway enrichment, or functional annotation is provided for excitatory neurons. All such analyses are restricted to microglial clusters.

**Spatial/Morphological Validation**  
No spatial, morphological, or in situ validation is performed for excitatory neurons. Immunohistochemistry and automated image analysis were used exclusively for microglial markers and subtypes.

**Disease Associations and Modulators**  
No associations between excitatory neuron subtypes and Alzheimer’s disease, pathology burden, or clinical variables are reported. The study does not discuss excitatory neuron changes in relation to age, sex, APOE genotype, or other host/genetic factors.

**Gene Regulatory Networks and Cell-Cell Communication**  
No gene regulatory network or ligand-receptor analyses involving excitatory neurons are presented.

**Aging/Disease Trajectories**  
No pseudotime or trajectory analyses are performed for excitatory neurons.

**Genetic or Multi-omic Integration**  
No eQTL, GWAS, or multi-omic integration is performed for excitatory neurons.

<keyFinding priority='3'>
The study reports that rare non-myeloid cells, including neurons, were detected in some samples and served as positive controls for the experimental pipeline, but no further analysis was performed on these cells.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
The study provides no disease-specific roles, mechanistic insights, or biomarker/therapeutic implications for excitatory neurons in Alzheimer’s disease or aging. All clinical relevance is centered on microglial subtypes.
</clinical>

---

**Quick Reference (≈50–100 words):**  
This study does not characterize excitatory neurons in human cortex. The single-cell RNA-seq pipeline was designed to isolate and analyze live microglia, with rare detection of non-myeloid cells (including neurons) only as positive controls. No excitatory neuron subtypes, marker genes, or disease associations are reported.

---

**Detailed Summary (≈800–1000 words):**  
The study by Olah et al. (2020) is a comprehensive single-cell RNA sequencing analysis of live immune cells, primarily microglia, isolated from human cortical tissue in the context of Alzheimer’s disease and aging. The experimental design, cell isolation, and downstream analyses were all optimized for the characterization of microglial heterogeneity. The authors processed autopsy samples from aged individuals (DLPFC, n=14) and surgical resections from epilepsy patients (TNC, n=3), using a validated pipeline to enrich for live myeloid cells.

The resulting dataset comprised 16,242 single-cell transcriptomes, of which >99% were identified as myeloid cells (microglia or monocytes), based on canonical marker gene expression (e.g., AIF1, CD14, C1QA). The authors performed unsupervised clustering and identified nine robust microglial subpopulations, which were further characterized by marker genes, functional signatures, and disease associations. Extensive validation was performed using immunohistochemistry, in situ quantification, and replication in independent single-nucleus RNA-seq datasets.

Excitatory neurons were not a focus of this study. The cell isolation protocol, which involved mechanical dissociation, myelin depletion, and FACS sorting for CD11b+/CD45+ live cells, was specifically designed to exclude neurons and other non-myeloid cell types. The authors note that rare non-myeloid cells—including neurons, astrocytes, T cells, B cells, and erythrocytes—were detected in some samples. These rare cells served as positive controls for the experimental and computational pipeline’s ability to resolve different cell types, but were not analyzed further.

No clustering, subtyping, or marker gene analysis was performed for excitatory neurons. The study does not report any excitatory neuron-specific findings, nor does it provide data on their proportions, gene expression changes, or functional states in Alzheimer’s disease or aging. All differential gene expression, pathway enrichment, and functional annotation analyses are restricted to microglial clusters.

Similarly, no spatial or morphological validation was performed for excitatory neurons. The immunohistochemistry and automated image analysis were used exclusively to validate microglial subtypes and their abundance in situ.

The study does not discuss any associations between excitatory neuron subtypes and disease status, pathology burden (amyloid, tau), clinical variables, or host/genetic factors (age, sex, APOE genotype). No gene regulatory network, cell-cell communication, or multi-omic integration analyses involving excitatory neurons are presented. No pseudotime or trajectory analyses are performed for excitatory neurons.

In summary, while the dataset may contain a small number of excitatory neurons as contaminants, the study does not provide any characterization, subtyping, or disease association for this cell type. The focus is entirely on microglial heterogeneity and its relevance to Alzheimer’s disease.

<keyFinding priority='3'>
The only mention of excitatory neurons is as rare, non-myeloid contaminants used to confirm the specificity and sensitivity of the cell isolation and sequencing pipeline. No further analysis is performed on these cells.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
**Research Implications (≈100–200 words):**  
This study does not advance knowledge regarding excitatory neuron heterogeneity, disease-associated states, or functional roles in Alzheimer’s disease or aging. The experimental design and analytical focus were exclusively on microglia, with neurons only incidentally detected as rare contaminants. As such, the dataset is not suitable for the systematic study of excitatory neuron subtypes or their involvement in neurodegenerative disease. Future studies aiming to characterize excitatory neurons in human cortex, particularly in the context of Alzheimer’s disease, will require protocols specifically designed to capture and profile neuronal populations, such as single-nucleus RNA-seq or neuron-enriched single-cell approaches. No conflicts or contradictions with prior models of excitatory neuron diversity or disease association are discussed, as the topic is not addressed in this paper.
...
# summary for Prashant 2024 (excitatory neurons)

**Quick Reference**

This large-scale single-nucleus RNA-seq (snRNA-seq) atlas of Parkinson’s disease (PD) profiled over 2 million nuclei from five brain regions across 100 donors (75 PD, 25 controls), capturing the full spectrum of PD pathology. Excitatory neurons were robustly identified as a major cell class across all regions, but the paper does not report detailed subclustering, marker gene signatures, or disease-associated subtypes for excitatory neurons. No significant PD-associated excitatory neuron subpopulations or gene expression changes are described, and no major genetic or demographic modulators are highlighted for this cell type.
...
<methods>
This study generated single-nucleus RNA-seq (snRNA-seq) and whole-genome sequencing (WGS) data from 100 postmortem human donors (75 PD, 25 controls), sampling five brain regions: dorsal motor nucleus of the Xth nerve (DMNX), globus pallidus interna (GPI), primary motor cortex (PMC), dorsolateral prefrontal cortex (DLPFC), and primary visual cortex (PVC). The cohort spans the full Braak PD staging spectrum. Nuclei were isolated, hashed, and sequenced using 10x Genomics 3’ v3.1 chemistry, with rigorous quality control and computational demultiplexing. Cell clustering and annotation were performed using SCANPY and Pegasus, with batch correction and reference-based validation.
</methods>

<findings>
The dataset comprises 2,096,155 high-quality nuclei, with broad representation across brain regions and disease stages. Major cell types—including excitatory neurons, inhibitory neurons, oligodendrocytes, astrocytes, microglia, OPCs, endothelial, mural, and ependymal cells—were robustly identified by unsupervised clustering and marker gene analysis. Excitatory neurons formed a prominent cluster in UMAP space, consistent with their expected abundance in cortical and subcortical regions.

However, the paper does not report further subclustering or subtype resolution within the excitatory neuron population. There is no breakdown of excitatory neuron subtypes (e.g., by cortical layer, projection class, or disease-associated state), nor are specific marker genes or functional signatures for excitatory neuron subpopulations described. The authors do not present differential abundance or gene expression analyses for excitatory neurons in relation to PD status, Braak stage, or other clinical variables. No pathway enrichment, gene regulatory network, or cell-cell communication findings are reported for this cell type.

The study’s main focus is on dataset generation, quality control, and resource sharing, rather than in-depth biological dissection of individual cell types. As such, the excitatory neuron population is treated as a single, broad class, and no disease-associated or homeostatic subtypes are delineated. There is no mention of spatial, morphological, or pseudotime analyses specific to excitatory neurons, nor are any genetic or demographic modulators (e.g., age, sex, risk alleles) highlighted as influencing this cell type.

<keyFinding priority='3'>
Excitatory neurons are robustly identified as a major cell class across all sampled brain regions, but no subtypes or disease-associated states are reported for this cell type.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
No disease-specific roles, mechanistic insights, or biomarker/therapeutic implications are proposed for excitatory neurons in this dataset. The paper does not discuss excitatory neuron vulnerability, gene expression changes, or subtype shifts in PD, and no associations with clinical or pathological variables are presented for this cell type.
</clinical>
...
This dataset provides a valuable resource for future studies of excitatory neuron diversity and PD-related changes, but the current paper does not analyze excitatory neuron subtypes, marker genes, or disease associations in detail. Open questions include whether excitatory neuron subpopulations (e.g., layer-specific or projection-defined types) show selective vulnerability, altered gene expression, or functional shifts in PD, and how these may relate to cognitive or motor symptoms. The lack of reported findings for excitatory neurons in this paper is consistent with its focus as a data descriptor and resource release, rather than a mechanistic or hypothesis-driven study. Future analyses leveraging this dataset could address these gaps, potentially integrating with known excitatory neuron classification schemes or comparing with prior single-cell studies in PD and related disorders.

No explicit conflicts or contradictions with prior models are discussed for excitatory neurons in this paper.
<contradictionFlag>none</contradictionFlag>
...
# summary for Sadick 2022 (excitatory neurons)
...
<methods>
Single-nucleus RNA sequencing (snRNA-seq) was performed on postmortem human prefrontal cortex from AD and age-matched non-symptomatic (NS) donors, all with APOE ε2/3 genotype. Astrocytes were enriched by FACS (LHX2+/NeuN–), but all major cell types were captured. Pathology (amyloid, tau, GFAP) was quantified in the same tissue region as sequencing. Data were integrated with published AD snRNA-seq datasets for cross-study comparison.
</methods>

<findings>
**Cell Type Proportions and General Findings**  
Excitatory neurons were present in the dataset but were not the primary focus of enrichment. The study’s main analyses and clustering centered on astrocytes and oligodendrocytes, with neurons (including excitatory neurons) making up a minority of captured nuclei due to the enrichment strategy. The authors do not report detailed subclustering or extensive transcriptomic analysis of excitatory neurons in this study.

**Excitatory Neuron Subtypes and Heterogeneity**  
The initial clustering (Figure 1C-D) identified broad cell types, including two neuronal clusters labeled "Neuron A" and "Neuron B." Marker gene analysis (Figure 1D) shows that these clusters express canonical excitatory neuron markers such as SLC17A7 (VGLUT1), STMN2, and GRIN2A, distinguishing them from inhibitory neurons (GAD1, GAD2). However, the paper does not further subdivide excitatory neurons into finer subtypes or states, nor does it provide a detailed breakdown of their marker genes beyond these canonical markers.

**Disease-Associated Changes in Excitatory Neurons**  
The authors do not report significant or systematic changes in the proportion, gene expression, or subtypes of excitatory neurons between AD and NS donors. Their analyses and figures focus almost exclusively on glial cells. There is no mention of disease-associated excitatory neuron subtypes, nor are there data on excitatory neuron-specific differential gene expression, pathway enrichment, or spatial/morphological validation.

**Integration and Cross-Dataset Comparison**  
When integrating their data with other published AD snRNA-seq datasets, the authors again focus on astrocytes and oligodendrocytes. Excitatory neurons are not analyzed in detail, and no new subtypes or disease-associated states are reported for this cell type.

**Modulators, Metrics, and Trajectories**  
No host or genetic factors, activation scores, or disease trajectory analyses are reported for excitatory neurons. The study does not discuss gene regulatory networks, cell-cell communication, or spatial localization for excitatory neuron subtypes.

**Summary of Negative Findings**  
<keyFinding priority='3'>
The study reports minimal findings for excitatory neurons: they are present as broad clusters defined by canonical markers, but no disease-associated subtypes, differential expression, or functional changes are described.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
The paper does not provide mechanistic or clinical insights regarding excitatory neurons in Alzheimer’s disease. No evidence is presented for excitatory neuron subtypes driving or mitigating pathology, nor are there implications for biomarkers or therapy based on this cell type.
</clinical>

---

**Quick Reference (≈50–100 words):**  
Excitatory neurons were captured as two broad clusters in this snRNA-seq study of AD and control human cortex, defined by canonical markers (e.g., SLC17A7, STMN2, GRIN2A). However, the authors report no significant disease-associated subtypes, differential gene expression, or functional changes in excitatory neurons between AD and non-symptomatic APOE ε2/3 donors. The study’s enrichment strategy and analyses focused on glial cells, leaving excitatory neuron heterogeneity largely uncharacterized.

---

**Research Implications (≈100–200 words):**  
This study provides little new information on excitatory neuron heterogeneity or disease-associated states in Alzheimer’s disease, as the experimental design and analyses were tailored to glial cells. The absence of reported findings for excitatory neurons highlights a gap in the current dataset: while broad neuronal clusters were identified, no subclustering, disease-stage transitions, or functional annotation was performed for excitatory neurons. This leaves open questions about whether excitatory neuron subtypes or states—such as those implicated in synaptic dysfunction or selective vulnerability in AD—might be detectable with deeper sequencing, neuron-focused enrichment, or alternative analysis pipelines. The lack of findings here does not contradict prior reports of excitatory neuron vulnerability in AD, but rather reflects the study’s glia-centric approach. Future work integrating neuron-enriched snRNA-seq, spatial transcriptomics, or multi-omic profiling will be needed to resolve excitatory neuron subtypes and their roles in AD pathogenesis.  
<contradictionFlag>none</contradictionFlag>
...
# summary for Serrano-Pozo 2024 (excitatory neurons)
...
<methods>
Single-nucleus RNA sequencing (snRNA-seq) was performed on 628,943 nuclei enriched for astrocytes from five brain regions (entorhinal cortex [EC], inferior temporal gyrus [ITG], dorsolateral prefrontal cortex [PFC], secondary visual cortex [V2], and primary visual cortex [V1]) from 32 human donors spanning normal aging to severe AD. Neuronal (NeuN+) and oligodendroglial (OLIG2+) nuclei were depleted by FANS. Adjacent tissue was analyzed for amyloid-β (Aβ) plaque load (immunohistochemistry) and pTau/tau ratio (ELISA). Cell type identification was based on canonical markers. Validation included immunohistochemistry and in situ hybridization.
</methods>

<findings>
**Cell Type Proportions and General Patterns**  
Excitatory neurons were not the primary focus of this study; nuclei were specifically depleted for NeuN+ (neuronal) markers prior to snRNA-seq, resulting in very low representation of excitatory neurons in the dataset. The study’s design and enrichment strategy mean that findings for excitatory neurons are extremely limited and largely negative. The vast majority of nuclei analyzed and all major findings pertain to astrocytes.  
<keyFinding priority='3'>The dataset contains minimal data on excitatory neurons due to intentional depletion during nuclei sorting. No significant findings regarding excitatory neuron subtypes, gene expression, or disease associations are reported.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>

**Excitatory Neuron Subtypes and Marker Genes**  
No systematic identification or characterization of excitatory neuron subtypes or states is presented in this paper. The only mention of excitatory neurons is in the context of cell type depletion and as a reference for regional vulnerability to AD pathology (e.g., EC layer II excitatory neurons are known to be vulnerable, but this is not explored with new data here).  
<keyFinding priority='3'>No excitatory neuron subtypes, marker genes, or functional states are described or analyzed in this study.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>

**Differential Gene Expression and Pathway Enrichment**  
No differential gene expression or pathway enrichment analyses are reported for excitatory neurons. All such analyses are restricted to astrocytes.  
<keyFinding priority='3'>No data on differential gene expression, pathway enrichment, or disease associations for excitatory neurons are provided.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>

**Spatial, Morphological, and Temporal Findings**  
No spatial, morphological, or temporal analyses of excitatory neuron states or subtypes are presented. The only indirect reference is to the known vulnerability of EC layer II excitatory neurons to tau pathology, which is cited from prior literature and not newly analyzed here.  
<keyFinding priority='3'>No spatial or temporal trajectory data for excitatory neurons are included.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>

**Modulators, Metrics, and Cell-Cell Communication**  
No analysis of genetic, demographic, or pathological modulators of excitatory neuron states is performed. No ligand-receptor or cell-cell communication analyses involving excitatory neurons are reported.  
<keyFinding priority='3'>No modulators, metrics, or cell-cell communication findings for excitatory neurons are presented.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>

**Integration with Genetic or Multi-omic Data**  
No eQTL, GWAS, or multi-omic integration is performed for excitatory neurons in this study.  
<keyFinding priority='3'>No genetic or multi-omic integration for excitatory neurons is reported.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
No disease-specific roles, mechanistic insights, or biomarker/therapeutic implications for excitatory neurons are derived from this study. The only disease relevance mentioned is the well-established vulnerability of EC layer II excitatory neurons to tau pathology, which is referenced from prior work and not newly analyzed here.  
<keyFinding priority='3'>No new clinical or mechanistic insights regarding excitatory neurons are provided in this paper.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
</clinical>
...
**Quick Reference (≈50–100 words):**  
This study intentionally depleted excitatory neurons during nuclei isolation, resulting in minimal data and no significant findings for this cell type. No excitatory neuron subtypes, marker genes, or disease-associated states are reported. All major results pertain to astrocytes. The only mention of excitatory neurons is as a reference to known regional vulnerability (e.g., EC layer II), but no new data are provided for this cell type.  
<keyFinding priority='3'>No significant findings for excitatory neurons due to intentional depletion; all analyses focus on astrocytes.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
...
This large-scale snRNA-seq study of human postmortem brain tissue in Alzheimer’s disease focused exclusively on astrocytes, using a nuclei enrichment strategy that specifically depleted NeuN+ (neuronal) and OLIG2+ (oligodendroglial) nuclei prior to sequencing. As a result, excitatory neurons are almost entirely absent from the dataset, and no systematic analysis of this cell type is performed. The study’s methods, results, and discussion are centered on astrocyte heterogeneity, spatial and temporal transcriptomic changes, and disease-associated astrocyte states.

Excitatory neurons are mentioned only in the context of (1) the depletion strategy (to enrich for astrocytes), and (2) as a reference to the known vulnerability of EC layer II excitatory neurons to tau pathology, which is cited from prior literature and not newly analyzed here. No subtypes, marker genes, or functional states of excitatory neurons are identified or characterized. No differential gene expression, pathway enrichment, or spatial/morphological analyses are performed for this cell type. No modulators, metrics, or cell-cell communication involving excitatory neurons are reported, and no genetic or multi-omic integration is presented.

The absence of excitatory neuron data is a direct consequence of the study’s design, which was optimized for astrocyte discovery. The authors do not discuss any findings, contradictions, or implications for excitatory neurons, and no validation or spatial analysis is performed for this cell type. All major findings, including the identification of astrocyte subclusters, disease-associated states, and spatial/temporal trajectories, are restricted to astrocytes.

<keyFinding priority='3'>The study provides no new data or insights on excitatory neurons due to their intentional depletion during nuclei isolation. All analyses and conclusions are limited to astrocytes.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
...
**Research Implications (≈100–200 words):**  
The absence of excitatory neuron data in this study highlights a limitation of cell type enrichment strategies in single-nucleus RNA-seq, particularly when the goal is to characterize glial heterogeneity. While the regional vulnerability of excitatory neurons (e.g., EC layer II) to tau pathology is well established in the literature, this study does not provide new insights or challenge existing models for this cell type. Future studies aiming to dissect excitatory neuron heterogeneity, disease-associated states, or neuron-glia interactions in Alzheimer’s disease will require either unbiased nuclei isolation or neuron-specific enrichment. The findings here do not conflict with prior models of excitatory neuron vulnerability, but simply do not address them.  
<keyFinding priority='3'>No conflicts or new directions for excitatory neuron research are raised by this study; the field remains reliant on other datasets for neuron-specific insights.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
...
**Summary:**  
This paper provides no significant findings for excitatory neurons due to their intentional depletion during nuclei isolation. All analyses and conclusions are restricted to astrocytes. No subtypes, marker genes, or disease associations for excitatory neurons are reported.  
<keyFinding priority='3'>No significant findings for excitatory neurons; all results pertain to astrocytes.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
...
# summary for Smith 2021 (excitatory neurons)
...
<methods>
Single-nucleus RNA sequencing (snRNA-seq) was performed on post-mortem human entorhinal and somatosensory cortex from 6 AD (Braak III–VI) and 6 non-diseased control (NDC, Braak 0–II) brains. Nuclei were enriched for astrocytes and microglia by FACS-based negative selection (removal of NeuN+ and Sox10+ nuclei). Data integration and clustering were performed using Seurat and LIGER. Differential gene expression was regressed against quantitative regional amyloid-beta and pTau pathology. Validation included immunohistochemistry and comparison to four published human AD snRNA-seq datasets.
</methods>

<findings>
**Cell Type Proportions:**  
Excitatory neurons were not the focus of enrichment and thus were underrepresented in the dataset. The majority of nuclei analyzed were astrocytes and microglia, with smaller clusters of neurons, oligodendrocytes, and vascular cells identified (Fig. 1b). The neuronal clusters, including excitatory neurons, were not analyzed further in this study.

**Differential Gene Expression:**  
The study did not report detailed findings for excitatory neurons. The main analyses, including differential gene expression and pathway enrichment, were performed on astrocyte and microglial populations. Excitatory neuron clusters were identified by canonical markers (e.g., RBFOX3, SLC17A7), but no disease-associated changes or subtypes were described for these cells.

**Pathway Enrichment:**  
No pathway enrichment or functional analysis was reported for excitatory neurons. All pathway and gene ontology analyses were focused on glial populations.

**Cell Subtype Identification & Characterization:**  
Excitatory neurons were not subclustered or characterized in this study. The UMAP (Fig. 1b) shows a single cluster labeled as "Neurons," without further subdivision or analysis. No subtypes, marker genes, or disease associations were reported for excitatory neurons.

**Modulators & Metrics:**  
No modulators (e.g., age, sex, APOE genotype) or quantitative metrics were reported for excitatory neurons.

**Gene Regulatory Networks:**  
No gene regulatory network or transcription factor analysis was performed for excitatory neurons.

**Cell-Cell Communication:**  
CellChat analyses were performed only for astrocyte-microglia interactions. No ligand-receptor or cross-talk analyses involving excitatory neurons were reported.

**Spatial Analysis:**  
No spatial or morphological validation was performed for excitatory neurons.

**Aging/Disease Trajectories:**  
No pseudotime or trajectory analyses were performed for excitatory neurons.

**Genetic or Multi-omic Integration:**  
No eQTL or genetic risk integration was performed for excitatory neurons.

<keyFinding priority='3'>
The study included excitatory neurons in the initial clustering but did not analyze them further; no subtypes, marker genes, or disease associations were reported for this cell type.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
No disease-specific roles, mechanistic insights, or biomarker/therapeutic implications were reported for excitatory neurons in this study. The focus was exclusively on glial responses (astrocytes and microglia) to AD pathology.
</clinical>

---

**Quick Reference (≈50–100 words):**  
Excitatory neurons were present as a minor cluster in this snRNA-seq study of Alzheimer’s disease cortex, but the analysis was focused on astrocytes and microglia. No subtypes, marker genes, or disease associations were reported for excitatory neurons, and no genetic or pathological drivers were identified for this cell type. <keyFinding priority='3'></keyFinding> <confidenceLevel>high</confidenceLevel>

---

**Detailed Summary (≈800–1000 words):**  
This study by Smith et al. (2022) used single-nucleus RNA sequencing to profile glial responses to Alzheimer’s pathology in human cortex, with a specific focus on astrocytes and microglia. Excitatory neurons were present in the dataset but were not the focus of enrichment or downstream analysis. The nuclei isolation protocol specifically enriched for glial populations by removing NeuN+ (neuronal) and Sox10+ (oligodendroglial) nuclei, resulting in a dataset dominated by astrocytes and microglia (Fig. 1b).

Within the integrated UMAP, a cluster labeled "Neurons" was identified, presumably containing both excitatory and inhibitory neurons. However, the study did not further subdivide or analyze this cluster. The heatmap of marker gene expression (Fig. 1c) includes RBFOX3 (NeuN) as a pan-neuronal marker, but no excitatory neuron-specific markers (such as SLC17A7/VGLUT1 or SLC17A6/VGLUT2) are highlighted, nor are inhibitory neuron markers discussed in detail. The main text and supplementary materials do not mention any findings related to excitatory neuron subtypes, disease-associated changes, or gene expression alterations.

All major analyses—including differential gene expression, pathway enrichment, gene co-expression modules, regulon analysis, and cell-cell communication—were performed exclusively on astrocyte and microglial populations. No results are presented for neuronal clusters, and no mention is made of excitatory neuron-specific responses to amyloid-beta or pTau pathology. The authors explicitly state that smaller numbers of nuclei from neurons, oligodendrocytes, and vascular cells were found but were not analyzed further (Fig. 1b legend).

No modulators (such as age, sex, or APOE genotype) or quantitative metrics (such as changes in cell proportions or activation scores) were reported for excitatory neurons. No spatial, morphological, or trajectory analyses were performed for this cell type. Similarly, no integration with genetic risk data or multi-omic datasets was performed for excitatory neurons.

In summary, while excitatory neurons were present in the dataset, the study did not report any findings—positive or negative—regarding their heterogeneity, disease associations, or functional states. The absence of analysis is consistent throughout the methods, results, and supplementary materials.

<keyFinding priority='3'>
Excitatory neurons were included in the initial clustering but were not analyzed for subtypes, marker genes, or disease associations; all major findings pertain to astrocytes and microglia.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
**Research Implications (≈100–200 words):**  
This study highlights a common limitation in single-nucleus RNA-seq studies that enrich for glial populations: excitatory neurons, though present, are underrepresented and not analyzed in detail. As a result, the transcriptional heterogeneity and disease-associated changes in excitatory neurons in Alzheimer’s disease remain unaddressed in this dataset. The lack of findings for excitatory neurons underscores the need for future studies to specifically enrich for and analyze neuronal populations, particularly given the central role of excitatory neuron loss and dysfunction in AD pathogenesis. The absence of reported subtypes or disease associations for excitatory neurons in this study is consistent with its glia-centric design and does not contradict prior literature, but it leaves open questions about how excitatory neuron states may interact with or be influenced by glial responses in AD. Future work integrating neuron-focused snRNA-seq with glial analyses will be essential to build a comprehensive cellular atlas of AD pathology.
...
# summary for Tuddenham 2024 (excitatory neurons)

<metadata>
Tuddenham JF, Taga M, Haage V, Marshe VS, Roostaei T, White C, Lee AJ, Fujita M, Khairallah A, Zhang Y, Green G, Hyman B, Frosch M, Hopp S, Beach TG, Serrano GE, Corboy J, Habib N, Klein HU, Soni RK, Teich AF, Hickman RA, Alcalay RN, Shneider N, Schneider J, Sims PA, Bennett DA, Olah M, Menon V, De Jager PL. "A cross-disease resource of living human microglia identifies disease-enriched subsets and tool compounds recapitulating microglial states." Nature Neuroscience. 2024 Dec;27:2521–2537. https://doi.org/10.1038/s41593-024-01764-7
Disease focus: Neurodegenerative and neuroinflammatory diseases (Alzheimer’s, Parkinson’s, ALS, MS, FTD, etc.)
</metadata>

<methods>
Single-cell RNA sequencing (scRNA-seq) of live, FACS-sorted CD45+ cells from 74 human donors across 12 CNS regions, spanning Alzheimer’s disease (AD), Parkinsonism, ALS, MS, FTD, epilepsy, stroke, and controls. Focused on microglia; excitatory neurons were not the primary target. Validation included in situ hybridization (RNAscope), immunofluorescence, and MERFISH spatial transcriptomics. 
</methods>

<findings>
**Cell Type Proportions:**  
Excitatory neurons were not directly profiled in this study. The scRNA-seq workflow specifically isolated CD45+ immune cells (primarily microglia and other myeloid cells), intentionally excluding neuronal populations. As a result, excitatory neurons are not represented in the single-cell transcriptomic data, and no quantitative or qualitative findings are reported for this cell type.

**Differential Gene Expression & Pathway Enrichment:**  
No differential gene expression, pathway enrichment, or disease association analyses were performed for excitatory neurons, as these cells were not captured in the dataset.

**Cell Subtype Identification & Characterization:**  
No excitatory neuron subtypes or states are described. The study’s clustering and marker gene analyses are restricted to microglia and other immune populations. No excitatory neuron markers (e.g., SLC17A7, CAMK2A, SATB2) are reported or discussed.

**Modulators & Metrics:**  
No host, genetic, or pathology-related modulators of excitatory neuron states are addressed.

**Gene Regulatory Networks, Cell-Cell Communication, Spatial Analysis:**  
No gene regulatory network, ligand-receptor, or spatial transcriptomic findings are reported for excitatory neurons. All spatial and in situ validation is focused on microglial markers.

**Aging/Disease Trajectories, Genetic/Multi-omic Integration:**  
No pseudotime, trajectory, or genetic risk analyses are performed for excitatory neurons.

<keyFinding priority='3'>
This study does not report any findings for excitatory neurons, as the experimental design specifically excluded neuronal populations from single-cell profiling.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
No disease-specific roles, mechanistic insights, or biomarker/therapeutic implications are presented for excitatory neurons in this study. The entire resource is focused on microglial heterogeneity and its relevance to neurological disease.
</clinical>

---

**Quick Reference (≈50–100 words):**  
This study does not report any findings for excitatory neurons. The single-cell RNA-seq resource exclusively profiles live CD45+ immune cells (primarily microglia) from human CNS tissue, intentionally excluding neuronal populations. As such, no excitatory neuron subtypes, marker genes, or disease associations are described or analyzed.

---

**Detailed Summary (≈800–1000 words):**  
The paper by Tuddenham et al. (2024, Nature Neuroscience) presents a comprehensive single-cell RNA-seq resource of live human microglia across a wide range of neurological diseases and CNS regions. The experimental design specifically targeted CD45+ immune cells, using FACS to isolate microglia and related myeloid populations from fresh postmortem and surgical brain tissue. As a result, neuronal populations—including excitatory neurons—were not captured or analyzed in this dataset.

Throughout the study, all clustering, marker gene analysis, and subtype characterization are focused on microglia. The authors identify 12 distinct microglial subtypes, describe their marker genes, functional signatures, and disease associations, and validate these findings with in situ hybridization and spatial transcriptomics. However, no data are presented for excitatory neurons:  
- No excitatory neuron clusters or subtypes are identified.  
- No excitatory neuron marker genes (e.g., SLC17A7, CAMK2A, SATB2) are reported.  
- No differential expression, pathway, or disease association analyses are performed for neurons.  
- No spatial or morphological validation is conducted for neuronal populations.

The study’s methods, results, and discussion are entirely centered on microglial heterogeneity and its relevance to neurodegenerative and neuroinflammatory disease. The absence of excitatory neuron data is a direct consequence of the cell isolation strategy, which was designed to maximize the yield and diversity of microglial states while excluding non-immune cells.

<keyFinding priority='3'>
The lack of excitatory neuron findings is not a limitation or oversight, but a deliberate aspect of the study design. The authors do not discuss or attempt to infer any neuronal biology from their data.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

No information is provided regarding excitatory neuron proportions, gene expression, subtypes, disease associations, or spatial localization. No modulators (e.g., age, sex, genotype), regulatory networks, or cell-cell communication involving excitatory neurons are addressed. The study’s multi-omic integration and disease trajectory analyses are restricted to microglia.

In summary, this resource is not applicable to the study of excitatory neuron heterogeneity or function in neurological disease.

---

**Research Implications (≈100–200 words):**  
This paper does not provide any data or insights relevant to excitatory neurons. Researchers interested in excitatory neuron heterogeneity, disease-associated states, or neuron-glia interactions will not find relevant information in this resource. The study’s design—focused exclusively on live CD45+ immune cells—precludes any analysis of neuronal populations. For single-cell or spatial transcriptomic studies of excitatory neurons in human brain, alternative datasets that profile unsorted or neuron-enriched cell suspensions (e.g., using single-nucleus RNA-seq or whole-cell dissociation without immune selection) should be consulted.

<keyFinding priority='3'>
No conflicts or contradictions with prior excitatory neuron literature are present, as this cell type is not addressed in the study.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
**Summary:**  
This paper is a resource for human microglial heterogeneity and does not contain any findings, analyses, or discussion relevant to excitatory neurons. All scientific content, validation, and disease relevance are restricted to microglia and related immune populations.
...
# summary for Xu 2021 (excitatory neurons)
...
<methods>
This study integrates single-cell and single-nucleus RNA sequencing (scRNA-seq and snRNA-seq) data from both transgenic mouse models (5XFAD) and human AD brains, focusing on immune cell populations. The analysis pipeline includes quality control, clustering, and differential gene expression, followed by network-based integration with protein–protein interactome, metabolite-enzyme associations, and drug-target data. The primary aim is to identify molecular networks in disease-associated microglia (DAM) and astrocytes (DAA) and prioritize drug candidates. Data sets included major brain regions (hippocampus, cortex, entorhinal cortex, superior frontal gyrus). Validation was performed using large-scale pharmacoepidemiologic data. Excitatory neurons were included in clustering and annotation but were not the primary focus of downstream network analyses.
</methods>

<findings>
**Cell Type Proportions and Subtype Identification**  
Excitatory neurons were among the major cell types identified in both mouse and human snRNA-seq data sets (e.g., GSE147528, GSE138852, Leng et al. 2021; Grubman et al. 2019). However, the study’s primary analyses and network reconstructions centered on microglia and astrocyte subtypes (DAM and DAA), with excitatory neurons serving as a reference/background population for clustering and annotation.

**Excitatory Neuron Subtypes and Marker Genes**  
The paper does not report the identification or characterization of distinct excitatory neuron subtypes or states in the context of Alzheimer’s disease. Excitatory neurons were annotated based on canonical marker genes (not explicitly listed in the main text), and their clustering was visualized in UMAP/t-SNE plots (e.g., Figure 4C,D), but no further subtype breakdown, differential gene expression, or disease-association analysis was performed for this cell type.

**Differential Gene Expression and Pathway Enrichment**  
No significant differential gene expression or pathway enrichment analyses were reported for excitatory neurons. The study’s differential expression and network analyses were restricted to microglia and astrocyte populations, with no mention of disease-associated or homeostatic subpopulations within excitatory neurons.

**Spatial/Morphological Validation**  
No spatial transcriptomics, in situ hybridization, or immunostaining validation was performed for excitatory neuron subtypes. Morphological or spatial findings were not reported for this cell type.

**Aging/Disease Trajectories**  
The study did not model aging or disease progression trajectories for excitatory neurons. No pseudotime or stage-specific analyses were conducted for this cell type.

**Modulators & Metrics**  
No quantitative changes in excitatory neuron proportions, nor any modulation by host/genetic factors (e.g., APOE genotype, sex, age), were reported.

**Gene Regulatory Networks, Cell-Cell Communication, and Multi-omic Integration**  
Excitatory neurons were not included in the molecular network reconstructions, gene regulatory network analyses, or cell-cell communication studies. No ligand-receptor or cross-talk analyses involving excitatory neurons were performed.

**Summary Statement**  
<keyFinding priority='3'>The study included excitatory neurons in clustering and annotation of sc/snRNA-seq data but did not identify, characterize, or analyze distinct excitatory neuron subtypes, nor did it report any disease-associated changes, marker genes, or functional pathways for this cell type.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
No disease-specific roles, mechanistic insights, or therapeutic implications were proposed for excitatory neurons in this study. The paper’s clinical and translational focus was exclusively on microglia and astrocyte molecular networks and their relevance to AD pathophysiology and drug repurposing.
</clinical>

---

**Quick Reference (≈50–100 words):**  
Excitatory neurons were included as a major cell type in the single-cell/nucleus RNA-seq data sets analyzed from both mouse and human AD brains, but the study did not identify or characterize any excitatory neuron subtypes, nor report disease-associated changes, marker genes, or functional pathways for this cell type. All major findings and network analyses focused on microglia and astrocytes, with no evidence for excitatory neuron heterogeneity or disease association in this work. <keyFinding priority='3'></keyFinding>

---

**Detailed Summary (≈800–1000 words):**  
The study by Xu et al. (2021) presents a comprehensive network-based analysis of single-cell and single-nucleus RNA sequencing data from both AD mouse models and human AD brains, with the primary goal of elucidating molecular networks in disease-associated microglia (DAM) and astrocytes (DAA) and identifying potential drug repurposing candidates. While the data sets analyzed included all major brain cell types—microglia, astrocytes, oligodendrocytes, oligodendrocyte progenitor cells, endothelial cells, inhibitory neurons, and excitatory neurons—the downstream analyses were almost exclusively focused on immune glial populations.

Excitatory neurons were annotated in the initial clustering and cell type identification steps, as evidenced by their inclusion in UMAP and t-SNE plots (e.g., Figure 4C,D, which show clustering of astrocytes and other cell types, including excitatory neurons, in human AD brain regions). The annotation of excitatory neurons was based on canonical marker genes, though these markers are not explicitly listed in the main text. The study does not report any further subdivision of excitatory neurons into subtypes or states, nor does it provide a breakdown of their marker gene expression profiles beyond the initial clustering.

No differential gene expression analyses were performed for excitatory neurons, either between AD and control samples or across disease stages. The study’s differential expression and network analyses were restricted to microglia and astrocyte populations, with a particular focus on identifying DAM and DAA subtypes, their marker genes, and their enrichment in AD-associated pathways. Excitatory neurons served as a background or reference population for clustering and annotation but were not the subject of any disease-association or functional analyses.

Similarly, no pathway enrichment, gene regulatory network, or cell-cell communication analyses were conducted for excitatory neurons. The study’s network-based methodology, which integrated transcriptomic data with protein–protein interactome, metabolite-enzyme associations, and drug-target networks, was applied exclusively to DAM and DAA populations. Excitatory neurons were not included in these molecular network reconstructions, nor were they analyzed for potential interactions with other cell types.

The study did not report any changes in the proportion of excitatory neurons between AD and control samples, nor did it examine the effects of host or genetic factors (such as APOE genotype, age, or sex) on excitatory neuron abundance or gene expression. No spatial transcriptomics, in situ hybridization, or immunostaining validation was performed for excitatory neuron subtypes, and no morphological or spatial findings were reported for this cell type.

Aging and disease progression trajectories were not modeled for excitatory neurons. The study did not employ pseudotime or stage-specific analyses to investigate potential changes in excitatory neuron states across the course of AD.

In summary, while excitatory neurons were present in the sc/snRNA-seq data sets and included in the initial clustering and annotation, the study did not identify, characterize, or analyze distinct excitatory neuron subtypes, nor did it report any disease-associated changes, marker genes, or functional pathways for this cell type. All major findings, including the identification of disease-associated subtypes, molecular network reconstructions, pathway enrichment, and drug repurposing analyses, were focused on microglia and astrocytes.

<keyFinding priority='3'>The absence of excitatory neuron subtype analysis or disease-association findings is a notable limitation for those interested in neuronal contributions to AD, but it reflects the study’s explicit focus on glial immune populations.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
**Research Implications (≈100–200 words):**  
The lack of excitatory neuron subtype characterization or disease-association analysis in this study highlights a gap in the current understanding of neuronal heterogeneity and its role in Alzheimer’s disease, at least within the context of this network-based, glia-focused approach. While the study’s methodology is robust for dissecting immune glial networks, future work should extend similar integrative analyses to excitatory neurons, particularly given their known vulnerability in AD and the emerging evidence for neuronal subtype-specific degeneration and dysfunction. The absence of excitatory neuron findings here does not contradict prior literature, as the authors did not attempt such analyses; rather, it underscores the need for dedicated studies of neuronal diversity and disease-associated states using single-cell and multi-omic approaches. Integration of excitatory neuron data with glial networks could provide a more comprehensive view of cell-cell interactions and disease mechanisms in AD.  
<contradictionFlag>none</contradictionFlag>

---

**Summary Table of Tag Usage:**  
- <keyFinding priority='3'>: Used to indicate the absence of significant findings for excitatory neurons.
- <confidenceLevel>high</confidenceLevel>: High confidence, as the lack of findings is clearly stated and consistent throughout the paper.
- <contradictionFlag>none</contradictionFlag>: No explicit contradictions or conflicts with prior data are discussed regarding excitatory neurons.

---

**Conclusion:**  
This study does not report any significant findings regarding excitatory neuron subtypes, marker genes, or disease associations in Alzheimer’s disease. All major analyses and conclusions pertain to microglia and astrocyte populations.
...
# summary for Zhang 2024 (excitatory neurons)

<metadata>
Zhang et al., 2024, Journal of Neuroinflammation.  
Disease focus: Perihematomal edema (PHE) after intracerebral hemorrhage (ICH).
</metadata>

<methods>
Single-cell RNA sequencing (scRNA-seq) was performed on perihematomal edematous tissue from 9 human ICH patients, sampled at three timepoints post-ICH (0–6h, 6–24h, 24–48h). UMAP clustering, differential gene expression, pathway enrichment, SCENIC regulon analysis, pseudotime, and cell-cell communication analyses were used. Immunofluorescence validated key ligand-receptor interactions.
</methods>
...
This study provides a comprehensive single-cell atlas of immune and non-immune cells in human perihematomal edema (PHE) after ICH, but **excitatory neurons were not detected or characterized as a distinct population** in the analyzed tissue. The scRNA-seq data and subsequent analyses focus almost exclusively on immune cells (microglia, neutrophils, monocytes, NK/T cells, B cells) and major glial/non-neuronal populations (astrocytes, oligodendrocytes, neural progenitors, endothelial cells), with no mention of excitatory neuron subtypes, marker genes, or disease associations.  
<keyFinding priority='1'>No excitatory neuron subtypes or disease-associated changes were reported in this PHE tissue scRNA-seq dataset.</keyFinding>  
<confidenceLevel>high</confidenceLevel>  
<contradictionFlag>none</contradictionFlag>
...
<findings>
The single-cell transcriptomic profiling of human PHE tissue after ICH, as reported by Zhang et al., aimed to map the immune landscape and cellular heterogeneity during the acute phase of secondary brain injury. The study identified 19 major cell clusters using UMAP and marker gene expression, including microglia, astrocytes, oligodendrocytes, neural progenitors, monocytes, neutrophils, NK/T cells, B cells, and endothelial cells (see Figure 1C/E). However, **no clusters corresponding to excitatory neurons were identified or annotated** in the dataset.

The authors provide a detailed breakdown of immune cell subtypes (especially microglia and neutrophils) and their dynamic changes during PHE progression. Astrocytes, oligodendrocytes, and neural progenitors are also annotated based on canonical marker genes (e.g., ALDH1L1, AQP4 for astrocytes; SOX10, MOG for oligodendrocytes; PDGFRA for progenitors). However, **no neuronal clusters—excitatory or inhibitory—are described, nor are neuronal marker genes (such as SLC17A7/VGLUT1, SLC17A6/VGLUT2, CAMK2A, or NEUN/RBFOX3) reported as defining any cluster**.

The tissue source—perihematomal edema adjacent to the hematoma cavity—likely explains the absence of excitatory neurons. This region is dominated by infiltrating immune cells and reactive glia, with neurons either absent, underrepresented due to technical dissociation biases, or not surviving the acute injury and sampling process. The authors acknowledge that their tissue sampling did not distinguish between gray and white matter, but the cell type composition is consistent with a non-neuronal, immune-enriched microenvironment.

Throughout the results, the focus remains on immune cell heterogeneity, microglial subtypes (including homeostatic and disease-associated states), neutrophil trajectories, and cell-cell communication (notably SPP1/osteopontin signaling). There is **no mention of excitatory neuron subtypes, their marker genes, functional states, or changes in proportion or gene expression**. No spatial, morphological, or trajectory analyses are presented for neurons, nor are any neuronal regulatory networks or ligand-receptor interactions discussed.

The absence of excitatory neurons is not explicitly discussed as a limitation, but the authors note that their dissociation and sampling strategy may bias against certain cell types and that their dataset does not provide a comprehensive representation of the original tissue's cellular composition.

<keyFinding priority='1'>Excitatory neurons were not detected or characterized in this PHE scRNA-seq dataset; the study focuses on immune and glial populations.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
Given the lack of excitatory neuron data, the study does not provide any disease-specific insights, mechanistic hypotheses, or therapeutic implications related to excitatory neurons in PHE or ICH. All clinical and mechanistic conclusions pertain to immune cell dynamics, microglial activation, and intercellular signaling in the context of secondary injury and inflammation.
</clinical>
...
The absence of excitatory neurons in this single-cell atlas of human PHE tissue highlights a critical gap in our understanding of neuronal vulnerability and response in the acute perihematomal environment. This may reflect true neuronal loss, technical limitations of tissue dissociation, or sampling bias toward immune-rich, non-neuronal regions. Future studies aiming to characterize excitatory neuron subtypes, their survival, stress responses, or interactions with immune cells in ICH/PHE will require alternative sampling strategies (e.g., inclusion of peri-infarct cortex or adjacent gray matter), optimized protocols for neuronal preservation, or spatial transcriptomics approaches.

This study's findings are consistent with prior reports that acute perihematomal regions are dominated by immune and glial cells, but the lack of neuronal data precludes comparison with known excitatory neuron classification schemes or disease-associated neuronal states. The authors do not explicitly discuss this as a contradiction, but it remains an open question whether excitatory neurons are absent, lost, or simply undetectable in this context.

<keyFinding priority='2'>The lack of excitatory neuron data underscores the need for targeted neuronal profiling in ICH/PHE to understand neuronal injury and repair mechanisms.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
**Summary:**  
**No excitatory neuron subtypes or disease-associated changes were detected in this human PHE scRNA-seq study.** The dataset and analyses are dominated by immune and glial populations, with no evidence for excitatory neuron presence or heterogeneity. This highlights a limitation of current single-cell approaches in acute injury settings and points to the need for future studies specifically addressing neuronal responses in ICH.
