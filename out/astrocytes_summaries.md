...
# summary for Jakel 2019 (astrocytes)

<metadata>
Jäkel S, Agirre E, Falcão AM, van Bruggen D, Lee KW, Knuesel I, Malhotra D, ffrench-Constant C, Williams A, Castelo-Branco G. "Altered human oligodendrocyte heterogeneity in multiple sclerosis." Nature. 2019 May 9;566(7745):543–547. doi:10.1038/s41586-019-0903-2.
Disease focus: Multiple Sclerosis (MS)
</metadata>

<methods>
Single-nucleus RNA sequencing (snRNA-seq) was performed on post-mortem human white matter (WM) from five controls and four progressive MS patients, including normal-appearing white matter (NAWM) and various lesion types (active, chronic active, chronic inactive, remyelinated). The 10x Genomics platform was used. Cell type and subcluster identities were validated by immunohistochemistry (IHC) and in situ hybridization (ISH) on independent tissue cohorts.
</methods>
...
This study used snRNA-seq to profile human white matter in MS and controls, revealing that astrocytes form a distinct cluster but are not further subtyped or deeply analyzed in this dataset. The main focus is on oligodendrocyte lineage heterogeneity, with astrocytes identified by canonical markers (e.g., GJA1, AQP4) but without disease-associated astrocyte subtypes or significant transcriptomic changes reported. No major astrocyte subpopulations or disease-specific states are described, and their proportions remain stable across MS and control samples. <keyFinding priority='3'>Astrocytes are transcriptionally stable and not a focus of heterogeneity or disease association in this study.</keyFinding> <confidenceLevel>high</confidenceLevel> <contradictionFlag>none</contradictionFlag>
...
<findings>
The study by Jäkel et al. (2019) provides a comprehensive single-nucleus transcriptomic atlas of human white matter in multiple sclerosis (MS) and control brains, with a primary focus on oligodendrocyte lineage cells. Astrocytes are identified as a major non-neuronal cell type in the dataset, but the analysis does not extend to detailed subclustering or disease-associated heterogeneity within the astrocyte population.

**Cell Type Proportions and Identification:**
Astrocytes are robustly detected in both control and MS white matter samples, forming a distinct cluster in tSNE projections (see Figure 1g, where GJA1 and AQP4 mark astrocytes). The proportion of astrocytes relative to other cell types (neurons, oligodendrocytes, microglia, endothelial cells, etc.) is not reported to change significantly between MS and control samples. The main quantitative and qualitative analyses of cell type proportions focus on oligodendrocyte lineage cells, with astrocytes serving as a reference population for cell type identification.

**Differential Gene Expression and Subtype Analysis:**
No differential gene expression analysis is reported for astrocytes between MS and control samples. The study does not identify or describe any astrocyte subtypes, disease-associated astrocyte states, or transcriptomic shifts in astrocytes in the context of MS. The clustering and marker gene analyses are centered on oligodendrocyte subpopulations, with astrocytes included only as a canonical cell type for annotation purposes.

**Pathway Enrichment and Functional Implications:**
There is no pathway enrichment or functional annotation presented for astrocytes in this study. The gene ontology and pathway analyses are performed exclusively on oligodendrocyte subclusters to elucidate their functional diversity and disease associations.

**Spatial and Morphological Validation:**
Astrocyte identity is confirmed by canonical marker expression (GJA1, AQP4) in the snRNA-seq data and tSNE plots. However, there is no spatial, morphological, or in situ validation of astrocyte subpopulations or disease-associated changes. The IHC and ISH validation experiments are directed at oligodendrocyte markers and subtypes.

**Aging/Disease Trajectories and Modulators:**
The study does not report any temporal modeling, pseudotime analysis, or investigation of aging/disease trajectories for astrocytes. All such analyses are focused on the oligodendrocyte lineage. No modulators (age, sex, genetic risk factors) are reported to influence astrocyte states or proportions in this dataset.

**Gene Regulatory Networks and Cell-Cell Communication:**
There is no analysis of gene regulatory networks, transcription factors, or ligand-receptor interactions involving astrocytes. The study does not address astrocyte-mediated cell-cell communication in MS pathology.

**Genetic or Multi-omic Integration:**
No integration of genetic risk variants, eQTLs, or multi-omic data is performed for astrocytes. The study’s multi-omic and cross-species comparisons are limited to oligodendrocyte lineage cells.

**Summary of Negative Findings:**
<keyFinding priority='3'>Astrocytes are transcriptionally stable and not a focus of heterogeneity or disease association in this study.</keyFinding> <confidenceLevel>high</confidenceLevel> <contradictionFlag>none</contradictionFlag>
The authors do not report any significant findings, subtypes, or disease associations for astrocytes, and their analysis does not contradict prior knowledge or models regarding astrocyte involvement in MS. The absence of astrocyte heterogeneity or disease-associated states is consistent with the study’s design, which prioritizes oligodendrocyte lineage diversity.
</findings>

<clinical>
Astrocytes are not implicated in MS-specific mechanisms or pathology in this study. No mechanistic insights, therapeutic implications, or biomarker potential are discussed for astrocytes. The study’s conclusions regarding disease progression and therapeutic targets are centered on oligodendrocyte heterogeneity and do not extend to astrocytes.
</clinical>
...
The lack of astrocyte subtype identification or disease-associated transcriptomic changes in this study highlights a gap in the current single-nucleus RNA-seq analysis of MS white matter. While astrocytes are robustly detected and serve as a reference population, their potential heterogeneity and roles in MS pathology remain unexplored in this dataset. This contrasts with other recent studies that have identified disease-associated astrocyte states (e.g., A1/A2) in neurodegenerative and neuroinflammatory conditions. The absence of astrocyte findings here may reflect tissue selection (white matter focus), sequencing depth, or analytical prioritization of oligodendrocyte lineage cells. Future studies with targeted astrocyte analysis, deeper sequencing, or region-specific sampling may reveal astrocyte heterogeneity and disease associations not captured in this work. <contradictionFlag>none</contradictionFlag> The findings are consistent with the study’s focus and do not conflict with prior models, but they underscore the need for dedicated astrocyte-centric single-cell studies in MS.
...
# summary for Kaufman 2021 (astrocytes)
...
<methods>
This study used multimodal single-cell RNA sequencing (scRNA-seq) and surface protein profiling (CITE-seq) of peripheral blood mononuclear cells (PBMCs) from MS patients (RRMS, PPMS) and matched controls, totaling 497,705 transcriptomes and 355,433 surface protein profiles. Spatial RNA sequencing was performed on post mortem brain tissue from 6 progressive MS patients and 4 controls (~85,000 spot transcriptomes). The focus was on identifying and tracking CNS-homing immune cells, particularly in the context of natalizumab (VLA-4 blockade) treatment. Astrocyte characterization was assessed via spatial transcriptomics and cross-referenced with single-cell datasets.
</methods>

<findings>
**Overview:**  
Astrocytes were not the primary focus of this study, which centered on T cell populations, especially a pathogenic CD161+/LTB+ Th17/Tfh-like CD4+ T cell cluster (T09). However, astrocytes were included in the spatial transcriptomic analyses of MS brain tissue, and their signatures were considered in the context of immune cell localization and specificity controls.

**Cell Type Proportions:**  
The study does not report significant quantitative changes in astrocyte proportions between MS and control brains, nor does it identify disease-associated astrocyte subtypes or states. The spatial transcriptomics approach was used to localize immune cell signatures, with astrocyte and microglial markers serving as negative controls to ensure specificity of T cell signature enrichment.

**Differential Gene Expression & Subtype Identification:**  
Astrocyte subtypes or disease-associated states were not systematically characterized in this work. The authors explicitly state that the T09 (CD161+/LTB+) T cell signature did not overlap with astrocyte or microglial gene expression profiles, referencing a publicly available single-cell brain dataset (Schirmer et al., 2019) to confirm that developmental brain-resident cells, including astrocytes, did not enrich for the T09 signature. This was a critical control to validate the specificity of their immune cell tracking in brain tissue.

**Pathway Enrichment:**  
No pathway enrichment or functional analysis was performed for astrocytes. The study’s pathway analyses were restricted to T cell populations, particularly those involved in migration, adhesion, and encephalitogenicity.

**Spatial Analysis:**  
Astrocyte markers (e.g., GFAP) were used in immunohistochemistry to delineate brain regions and assess tissue integrity, but not to define astrocyte subtypes or activation states. The spatial transcriptomics data were primarily used to map the localization of T09 T cells, with astrocyte signatures serving as a reference to exclude confounding by resident glial cells.

**Aging/Disease Trajectories:**  
No astrocyte-specific aging or disease progression trajectories were modeled or discussed.

**Genetic or Multi-omic Integration:**  
No eQTL or genetic risk variant analyses were performed for astrocyte populations.

**Summary Statement:**  
<keyFinding priority='3'>The study found no evidence for disease-associated astrocyte subtypes or significant astrocyte transcriptomic changes in MS brain tissue using spatial RNA sequencing. Astrocyte signatures were used as negative controls to validate the specificity of T cell localization analyses.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
Astrocytes are not implicated as direct drivers or modulators of MS pathology in this study. The data do not support a role for astrocyte subtypes as biomarkers or therapeutic targets in the context of CNS immune cell colonization or progression to progressive MS. The findings reinforce the specificity of T cell–centric mechanisms in MS progression, as astrocyte signatures did not confound immune cell localization analyses.
</clinical>
...
Astrocytes were not found to exhibit disease-associated subtypes or significant transcriptomic changes in MS brain tissue in this study. Instead, astrocyte signatures served as negative controls in spatial transcriptomics, confirming that the pathogenic CD161+/LTB+ T cell population identified in progressive MS brains was not confounded by resident glial cells. No genetic or demographic modulators of astrocyte states were reported.

---

**Detailed Summary**

This study by Kaufmann et al. (2021) investigates the immune cell landscape in multiple sclerosis (MS), with a primary focus on identifying and tracking CNS-homing T cells using multimodal single-cell and spatial transcriptomic approaches. While the central findings revolve around a pathogenic CD161+/LTB+ Th17/Tfh-like CD4+ T cell population (T09), astrocytes were included in the spatial transcriptomic analyses as part of the broader brain cell milieu.

Astrocytes were not the main subject of investigation, and the study does not report the identification of distinct astrocyte subtypes, disease-associated states, or significant changes in astrocyte proportions between MS and control brains. Instead, astrocyte markers (such as GFAP) were used in immunohistochemistry to delineate brain regions and assess tissue integrity for spatial transcriptomics. In the spatial RNA sequencing analysis of post mortem brain tissue from progressive MS patients and controls, the authors specifically tested whether the T09 T cell signature could be confounded by expression in resident glial cells, including astrocytes.

To address this, the authors cross-referenced their T09 signature with a publicly available single-cell brain dataset (Schirmer et al., 2019), confirming that neither astrocytes nor microglia showed enrichment for the T09 gene set. This served as a critical negative control, ensuring that the observed spatial enrichment of the T09 signature in MS brain tissue was specific to infiltrating T cells and not due to resident glial populations. The spatial transcriptomics data revealed focal enrichment of the T09 signature in both white matter lesions and gray matter regions of MS brains, but not in controls, further supporting the specificity of immune cell localization.

No pathway enrichment, gene regulatory network, or cell-cell communication analyses were performed for astrocytes. The study’s functional and mechanistic analyses were restricted to T cell populations, particularly those involved in CNS migration and encephalitogenicity. There was no modeling of astrocyte aging or disease progression trajectories, nor were any genetic or multi-omic integrations performed for astrocyte populations.

The absence of astrocyte findings is explicitly acknowledged by the authors, who note that their approach did not identify significant differences in subpopulation frequencies or transcriptomic states for resident brain cells, including astrocytes, between MS and control samples. This is attributed in part to the high variability and limited sample size inherent in cross-sectional human studies.

<keyFinding priority='3'>Astrocyte signatures were used as negative controls in spatial transcriptomics to validate the specificity of T cell localization analyses in MS brain tissue. No disease-associated astrocyte subtypes or significant transcriptomic changes were identified.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

Thus, the study’s main contribution regarding astrocytes is methodological: by demonstrating that astrocyte (and microglial) gene expression does not confound the identification of CNS-infiltrating T cells, the authors strengthen the validity of their immune cell–centric findings.

</findings>

<clinical>
Astrocytes are not implicated as direct contributors to MS progression in this study. The data do not support a role for astrocyte subtypes as biomarkers or therapeutic targets in the context of CNS immune cell colonization or the transition to progressive MS. Instead, the findings reinforce the specificity of T cell–mediated mechanisms in MS pathology, as astrocyte signatures did not overlap with the pathogenic T cell populations identified.
</clinical>
...
The lack of significant astrocyte findings in this study highlights the specificity of immune cell–driven mechanisms in MS progression, at least as captured by the spatial transcriptomic and single-cell approaches used here. The use of astrocyte signatures as negative controls is a methodological strength, ensuring that immune cell localization analyses are not confounded by resident glial expression. However, the absence of astrocyte subtyping or activation state analysis leaves open the question of whether more sensitive or targeted approaches might reveal subtle astrocyte heterogeneity or disease associations in MS. Future studies with larger sample sizes, higher spatial resolution, or astrocyte-focused profiling may be needed to fully elucidate the role of astrocytes in MS progression. The findings are consistent with prior models that emphasize immune cell infiltration over glial cell-intrinsic changes in driving MS pathology, and no explicit contradictions with existing astrocyte literature are discussed by the authors.
...
# summary for Olah 2020 (astrocytes)

<quickReference>
This study (Olah et al., 2020, Nat Commun) performed single-cell RNA sequencing of live human brain immune cells, focusing on microglia but also capturing rare astrocytes. Astrocytes were detected as a minor population (cluster 13), defined by high GFAP expression and co-expression of some myeloid markers. No significant astrocyte subtypes or disease-associated astrocyte states were identified, and the main findings center on microglial heterogeneity in Alzheimer’s disease.
</quickReference>
...
<methods>
Single-cell RNA-seq (scRNA-seq) was performed on live immune cells isolated from human dorsolateral prefrontal cortex (DLPFC) autopsy samples (n=14, aged/AD/MCI) and temporal neocortex surgical resections (n=3, epilepsy). Cells were sorted for immune markers and sequenced using the 10x Genomics Chromium platform. Unsupervised clustering identified 14 cell clusters, with major focus on microglia. Immunohistochemistry and in situ validation were performed for selected markers.
</methods>

<findings>
Astrocytes were detected as a rare population in this dataset:
- Cluster 13 was annotated as "GFAP+" and interpreted as likely representing astrocytes, based on high expression of GFAP (glial fibrillary acidic protein), a canonical astrocyte marker. This cluster also showed expression of myeloid markers (AIF1, C1QA), as well as MBP and SNAP25.
- The authors note that this cluster could consist of cell doublets (astrocyte-myeloid), but this could not be unambiguously determined based on gene/UMI counts.
- The proportion of astrocytes was extremely low: cluster 13 contained only a small fraction of the total cells (<1%).
- No further subclustering or identification of astrocyte subtypes/states was performed or reported.
- No disease-associated astrocyte states, differential gene expression, or pathway enrichment analyses were presented for astrocytes.
- No spatial, morphological, or in situ validation was performed for astrocytes.
- The main focus of the study was on microglial heterogeneity; astrocytes were included as a positive control for cell type resolution in the pipeline.
- The authors do not report any significant changes in astrocyte proportions, gene expression, or states in relation to AD, aging, or other clinical/pathological variables.
- <keyFinding priority='3'>Astrocytes were detected as a rare GFAP+ cluster (cluster 13), with no evidence for further heterogeneity or disease association in this dataset.</keyFinding>
<confidenceLevel>medium</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

Other relevant details:
- The authors acknowledge that their immune cell isolation protocol is optimized for myeloid cells, and astrocytes are likely underrepresented.
- The presence of GFAP+ cells co-expressing myeloid markers raises the possibility of doublets or technical artifacts.
- No mention is made of canonical astrocyte subtypes (e.g., A1/A2, reactive, homeostatic) or marker genes beyond GFAP.
- No trajectory, pseudotime, or disease progression modeling was performed for astrocytes.
- No modulators (age, sex, APOE, GWAS) or cell-cell communication analyses were reported for astrocytes.
</findings>

<clinical>
The study does not provide evidence for astrocyte involvement in AD or aging-related pathology in this dataset. No mechanistic, biomarker, or therapeutic implications are discussed for astrocytes. The lack of astrocyte findings is likely due to technical limitations of the cell isolation protocol, which was not optimized for non-myeloid glia.
</clinical>
</detailedSummary>

<researchImplications>
This study highlights the technical challenge of capturing astrocytes in single-cell RNA-seq datasets optimized for immune/myeloid cells. The detection of a rare GFAP+ cluster, potentially contaminated by myeloid markers or doublets, precludes meaningful analysis of astrocyte heterogeneity or disease association. No astrocyte subtypes or disease-associated states (e.g., reactive, neurotoxic, neuroprotective) were identified, and no comparison to established astrocyte classification schemes was made. The findings do not conflict with prior models, but rather underscore the need for astrocyte-focused protocols (e.g., single-nucleus RNA-seq, astrocyte-specific sorting) to resolve astrocyte diversity and their roles in AD. Future studies should employ methods tailored to astrocyte capture and explicitly address their heterogeneity and disease relevance.
<contradictionFlag>none</contradictionFlag>
</researchImplications>

---

# summary for Otero-Garcia 2022 (astrocytes)
...
<methods>
This study developed a FACS-based method to isolate and profile single somas with and without NFTs from fresh-frozen human prefrontal cortex (BA9) of Braak VI AD donors and age-matched controls. Over 120,000 single-cell transcriptomes were generated (snRNA-seq/cytoplasmic RNA-seq). The approach enabled direct comparison of NFT-bearing and NFT-free neurons from the same tissue, with validation by immunohistochemistry (IHC), in situ hybridization (ISH), and spatial mapping.
</methods>

<findings>
Astrocytes—Cell Type Focus

**Cell Type Proportions and Subtype Identification**
Astrocytes are not the primary focus of this study, which centers on neuronal vulnerability to NFTs. However, the methods section and some results indicate that the FACS-based approach can, in principle, isolate glial cells (including astrocytes) with tau aggregates, as demonstrated in progressive supranuclear palsy (PSP) tissue. In the AD prefrontal cortex, the main analysis and clustering focus on neuronal subtypes, with astrocytes and other glia only briefly mentioned as part of the broader cell population.

The single-cell transcriptomic data include astrocytes, but the paper does not report detailed findings on astrocyte subtypes, marker genes, or disease-associated astrocyte states in the context of AD or NFT pathology. There is no breakdown of astrocyte subpopulations, nor are there quantitative changes in astrocyte proportions or explicit associations with NFTs or AD status.

**Differential Gene Expression and Pathway Enrichment**
No astrocyte-specific differential gene expression or pathway enrichment analyses are presented. The study’s main findings relate to neurons, particularly excitatory subtypes, and their transcriptional responses to NFTs. There is no mention of astrocyte marker genes (e.g., GFAP, AQP4, SLC1A2) or disease-associated astrocyte signatures (e.g., A1/A2, reactive, homeostatic) in the results.

**Spatial and Morphological Validation**
The only reference to glial cells with tau aggregates is in the context of PSP, where FACS plots and images show MAP2-negative/AT8-positive populations, which include oligodendrocytes and potentially astrocytes. In AD tissue, such glial populations are not analyzed further, and there is no spatial or morphological validation of astrocyte subtypes or states.

**Disease/Aging Trajectories and Modulators**
No data are provided on astrocyte dynamics across disease stages, nor are there analyses of genetic or host factors (age, sex, APOE) modulating astrocyte states in this dataset.

**Gene Regulatory Networks, Cell-Cell Communication, and Multi-omic Integration**
All such analyses are restricted to neuronal populations. There is no astrocyte-specific regulatory network, ligand-receptor, or eQTL analysis.

<keyFinding priority='3'>
Astrocytes are present in the single-cell dataset, but the study does not report any significant findings regarding astrocyte subtypes, marker genes, or disease-associated states in Alzheimer’s disease or NFT pathology.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
The study does not provide mechanistic or clinical insights into astrocyte roles in AD or NFT pathology. No astrocyte-specific biomarkers, therapeutic targets, or functional implications are discussed. The only clinical relevance is the demonstration that the FACS-based method could, in principle, be adapted to study glial tau pathology in primary tauopathies (e.g., PSP), but this is not pursued for astrocytes in AD.
</clinical>

---

**Quick Reference**
This study developed a method for high-throughput single-cell transcriptomics of NFT-bearing and NFT-free cells in AD cortex, but did not report significant findings for astrocytes: no astrocyte subtypes, marker genes, or disease-associated states were characterized, and astrocyte roles in NFT pathology or AD were not addressed. The main focus and all major findings pertain to neuronal populations.
...
<keyFinding priority='3'>
Astrocytes are included in the single-cell dataset generated by Otero-Garcia et al., but the study does not present any detailed analysis or findings regarding astrocyte subtypes, marker genes, or disease-associated states in Alzheimer’s disease or in relation to neurofibrillary tangle (NFT) pathology.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

The primary aim of the study was to resolve the molecular signatures underlying neuronal susceptibility to NFT formation in AD. The authors developed a FACS-based approach to isolate and profile single somas with and without NFTs from the human prefrontal cortex. While the method is capable of isolating glial cells (including astrocytes) with tau aggregates—as demonstrated in PSP tissue—astrocytes are not analyzed in detail in the context of AD.

In the main results, the authors focus on the identification and characterization of 20 neuronal subtypes, their vulnerability to NFT formation, and their transcriptional responses. The clustering and annotation of single-cell transcriptomes primarily distinguish excitatory and inhibitory neuronal subtypes, with glial cells (astrocytes, oligodendrocytes, microglia) only briefly mentioned as part of the overall cell population. There is no breakdown of astrocyte subtypes, nor are there data on changes in astrocyte proportions, gene expression, or functional states in AD or NFT-bearing tissue.

The study does not report any astrocyte-specific marker genes, nor does it discuss homeostatic versus reactive astrocyte states, disease-associated astrocyte (DAA) signatures, or any functional implications for astrocytes in AD. No pathway enrichment, gene regulatory network, or cell-cell communication analyses are performed for astrocytes. The spatial and morphological validation experiments are restricted to neuronal markers and NFT-bearing neurons.

The only mention of glial tau pathology is in the context of PSP, where the FACS method is shown to isolate MAP2-negative/AT8-positive glial cells, including oligodendrocytes with tau aggregates. However, in AD tissue, such glial populations are not further analyzed, and there is no evidence presented for astrocyte tau pathology or its molecular correlates.

The study does not address astrocyte dynamics across disease stages, nor does it analyze the impact of genetic or demographic factors on astrocyte states. All analyses of disease progression, gene regulatory networks, and multi-omic integration are restricted to neuronal populations.

In summary, while astrocytes are present in the dataset and the method could be adapted to study glial tau pathology, this paper does not provide any significant findings or insights regarding astrocyte heterogeneity, disease mechanisms, or clinical relevance in Alzheimer’s disease.

---

**Research Implications**

The absence of astrocyte-specific findings in this comprehensive single-cell study of AD cortex highlights a gap in the current understanding of astrocyte heterogeneity and their roles in NFT pathology. Although the FACS-based method is capable of isolating glial cells with tau aggregates, the lack of analysis for astrocytes in AD suggests that future studies should leverage this approach to systematically characterize astrocyte subtypes, marker genes, and disease-associated states in relation to tau pathology. This would be particularly relevant given the growing recognition of astrocyte contributions to neurodegeneration and neuroinflammation in AD. The study does not report any conflicts or contradictions with prior astrocyte literature, as astrocytes are not analyzed in detail.

<contradictionFlag>none</contradictionFlag>

---

# summary for Pfisterer 2020 (astrocytes)

<quickReference>
This study (Pfisterer et al., 2020, Nat Commun) used single-nucleus RNA-seq of human temporal cortex to dissect cell-type-specific transcriptomic changes in temporal lobe epilepsy (TLE). For astrocytes, the paper reports only minimal transcriptomic alterations and no significant disease-associated subtypes or states. Astrocytes showed no major changes in proportion, marker gene expression, or pathway enrichment between epileptic and control cortices, and the main findings focus on neuronal populations.
</quickReference>
...
<methods>
Single-nucleus RNA-seq (snRNA-seq) was performed on >110,000 nuclei from human temporal cortex, including both TLE patients and non-epileptic controls. Both neuronal (NeuN+) and non-neuronal (NeuN-) fractions were analyzed, with the latter containing glial cells such as astrocytes. Data integration and clustering were performed using Conos, and cell types were annotated using canonical markers. Validation included in situ hybridization and smFISH for select neuronal genes.
</methods>

<findings>
Astrocytes were identified within the NeuN-negative (non-neuronal) fraction, as confirmed by marker gene expression (Supplementary Fig. 1b–e). However, the main text and figures focus almost exclusively on neuronal subtypes, with only brief mention of glial populations.

**Cell Type Proportions:**  
The paper does not report any significant change in the proportion of astrocytes between epileptic and control samples. The NeuN-negative fraction was confirmed to be predominantly glial, but no compositional shifts for astrocytes are described.

**Differential Gene Expression:**  
No significant differentially expressed genes (DEGs) are reported for astrocytes in epilepsy versus control. The authors state that previous bulk transcriptomic studies found only minor changes in glial gene expression in epilepsy, and their single-nucleus data do not reveal substantial astrocyte-specific alterations.

**Pathway Enrichment:**  
There is no mention of pathway enrichment or functional shifts in astrocytes. The major pathway and GO term analyses are restricted to neuronal subtypes.

**Cell Subtype Identification & Characterization:**  
The study does not identify or characterize any astrocyte subtypes or disease-associated astrocyte states. All major findings regarding cell state heterogeneity, disease association, and marker gene shifts are limited to principal neurons and GABAergic interneurons.

**Modulators & Metrics:**  
No host or genetic factors (age, sex, genotype) are reported to modulate astrocyte states in this dataset.
...
None of these analyses are applied to astrocytes in this study.

<keyFinding priority='3'>
Astrocytes in the human temporal cortex show minimal transcriptomic changes in TLE, with no evidence for disease-associated subtypes or altered marker gene expression.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
The study provides no evidence for a disease-specific role of astrocytes in human TLE at the transcriptomic level. There are no mechanistic insights, biomarker implications, or therapeutic targets related to astrocytes discussed. The authors focus on neuronal circuits as the primary locus of epilepsy-associated molecular pathology.
</clinical>
</detailedSummary>

<researchImplications>
This study demonstrates that, in contrast to neurons, astrocytes in the human temporal cortex do not exhibit major transcriptomic alterations or disease-associated subtypes in TLE, at least as detected by snRNA-seq. This finding aligns with prior bulk transcriptomic studies reporting only minor glial changes in epilepsy. The lack of astrocyte heterogeneity or activation signatures in this dataset suggests that, in this brain region and disease context, astrocytes may not play a primary role in epileptogenesis, or that their contributions are not captured at the transcriptomic level or in the sampled tissue. Future studies could explore other brain regions, earlier disease stages, or use multi-omic and spatial approaches to further probe astrocyte involvement. No conflicts with prior astrocyte classification schemes or models are discussed by the authors.
</researchImplications>
...
# summary for Prashant 2024 (astrocytes)

**Quick Reference**

This large-scale single-nucleus RNA-seq atlas of Parkinson’s disease (Prashant N. M. et al., 2024, *Scientific Data*) profiled astrocytes across five brain regions and all Braak PD stages in 100 donors. Astrocytes were robustly identified as a major cell class, but the paper does **not report detailed astrocyte subtypes, marker genes, or disease-associated astrocyte states**. No significant changes in astrocyte proportions or transcriptomic states by PD status, region, or genotype are described. <keyFinding priority='2'>Astrocytes are present across all regions and disease stages, but no disease-associated astrocyte subpopulations or molecular signatures are highlighted.</keyFinding> <confidenceLevel>high</confidenceLevel> <contradictionFlag>none</contradictionFlag>
...
<methods>
This study generated single-nucleus RNA-seq (snRNA-seq) and whole-genome sequencing data from 100 postmortem human donors (75 PD cases, 25 controls), spanning the full spectrum of PD neuropathological severity (Braak PD stages 1–6). Five brain regions were sampled: dorsal motor nucleus of the vagus (DMNX), globus pallidus interna (GPI), primary motor cortex (PMC), dorsolateral prefrontal cortex (DLPFC), and primary visual cortex (PVC). Nuclei were isolated, hashed, and sequenced using 10x Genomics 3’ v3.1 chemistry. Data underwent rigorous demultiplexing, quality control, and batch correction. Cell type annotation was performed using clustering and marker gene analysis, with reference to published human brain atlases.
</methods>

<findings>
Astrocytes were robustly identified as one of the nine major cell types present across all sampled brain regions, as visualized in UMAP projections (Fig. 3g). The dataset includes over two million nuclei, with astrocytes forming a substantial fraction of the total cell population. However, the paper does **not provide a breakdown of astrocyte subtypes, nor does it report differential gene expression, pathway enrichment, or disease-associated molecular signatures specific to astrocytes**. No astrocyte subclusters, marker genes, or functional annotations (e.g., homeostatic vs. reactive) are described.

<keyFinding priority='2'>Astrocytes are present in all five brain regions and across all Braak PD stages, but the study does not identify or characterize distinct astrocyte subtypes or disease-associated states.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

The authors note that cell type proportions vary by brain region, with early PD-affected regions (e.g., DMNX, GPI) yielding fewer total nuclei, but they do not report quantitative changes in astrocyte abundance by disease status, region, or genotype. There is no mention of astrocyte-specific differential expression, pathway activation, or spatial/morphological validation.

<keyFinding priority='3'>No evidence is presented for astrocyte activation, reactivity, or association with α-synuclein pathology, Braak stage, or clinical variables.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>

The dataset is positioned as a resource for future exploration of cell type–specific changes in PD, but the current publication does not analyze astrocyte heterogeneity, disease trajectories, or genetic modulation (e.g., by risk alleles) within the astrocyte compartment.

No gene regulatory network, cell-cell communication, or multi-omic integration findings are reported for astrocytes. The authors confirm that major cell classes, including astrocytes, match reference transcriptomic profiles, supporting robust cell type annotation.

<keyFinding priority='3'>Astrocyte identity is validated by transcriptomic similarity to published human brain atlases, but no further molecular or functional characterization is provided.</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
The study does not report any disease-specific roles, mechanistic insights, or biomarker/therapeutic implications for astrocytes in Parkinson’s disease. The absence of astrocyte subtype analysis or disease association precludes conclusions about their contribution to PD pathogenesis in this dataset.
</clinical>
...
This dataset represents a valuable resource for the field, providing high-quality, multi-region snRNA-seq data across the full spectrum of PD pathology. However, the current publication does **not analyze astrocyte heterogeneity, disease-associated states, or molecular signatures**. The lack of astrocyte subtype or activation state characterization means that questions about astrocyte involvement in PD—such as the emergence of reactive or neurotoxic subpopulations, regional vulnerability, or genetic modulation—remain open. Future analyses leveraging this dataset could apply finer-grained clustering, trajectory inference, or integrative approaches to uncover astrocyte subtypes and their roles in PD progression. The absence of findings does not contradict prior reports, but highlights a gap for subsequent studies to address. <contradictionFlag>none</contradictionFlag>
...
# summary for Renthal 2018 (astrocytes)

**Quick Reference (Astrocytes in Renthal et al., 2018, Nat Neurosci):**  
Astrocytes in mosaic Rett syndrome brain tissue, analyzed by single-nucleus RNA-seq, did not show major disease-associated subtypes or strong differential gene expression between MECP2-mutant and wild-type cells. The study’s SNP-based transcriptotyping approach enabled cell-autonomous analysis, but astrocytes exhibited minimal transcriptional response to MECP2 loss compared to neurons, with no evidence for distinct disease-associated astrocyte states or significant modulation by genetic or demographic factors. <keyFinding priority='3'></keyFinding>
...
<methods>
The study employed single-nucleus RNA sequencing (snRNA-seq) on postmortem occipital cortex from three female Rett syndrome donors (MECP2 R255X mutation), as well as scRNA-seq in mosaic female Mecp2+/– mice. A novel SNP-based transcriptotyping method was used to distinguish wild-type and mutant nuclei within the same individual, enabling direct cell-autonomous comparisons. Cell types were identified using canonical markers, and differential expression was analyzed within each cell type, including astrocytes.  
</methods>

<findings>
Astrocytes were robustly identified in both mouse and human datasets using established marker genes (e.g., *ALDOC*). However, the primary focus of the study was on neuronal populations, particularly excitatory neurons and VIP interneurons, where MECP2-dependent gene expression changes were most pronounced.

For astrocytes, the following key points were reported:

- **Cell Type Proportions:**  
  The proportion of astrocytes among total nuclei was not significantly altered between MECP2-mutant and wild-type transcriptotypes in either mouse or human Rett syndrome samples. No evidence for selective vulnerability or expansion of astrocyte populations was presented. <keyFinding priority='3'></keyFinding> <confidenceLevel>medium</confidenceLevel> <contradictionFlag>none</contradictionFlag>

- **Differential Gene Expression:**  
  The study did not identify a substantial number of differentially expressed genes between MECP2-mutant and wild-type astrocytes. The magnitude and number of misregulated genes in astrocytes were minimal compared to neurons. This suggests that MECP2 loss in astrocytes does not drive major cell-autonomous transcriptional changes detectable by snRNA-seq in adult cortex. <keyFinding priority='2'></keyFinding> <confidenceLevel>medium</confidenceLevel> <contradictionFlag>none</contradictionFlag>

- **Cell Subtype Identification & Characterization:**  
  The analysis did not reveal distinct astrocyte subtypes or disease-associated astrocyte states (e.g., reactive, inflammatory, or neurotoxic subpopulations) in Rett syndrome tissue. Astrocyte clusters appeared transcriptionally homogeneous, with no evidence for emergence of novel subtypes or marked shifts in known astrocyte states. <keyFinding priority='2'></keyFinding> <confidenceLevel>medium</confidenceLevel> <contradictionFlag>none</contradictionFlag>

- **Pathway Enrichment:**  
  No significant pathway enrichment or functional signatures (e.g., inflammatory, metabolic, or synaptic support pathways) were reported as altered in MECP2-mutant astrocytes. This contrasts with the strong enrichment for methylation-dependent gene regulation observed in neurons. <keyFinding priority='2'></keyFinding> <confidenceLevel>medium</confidenceLevel> <contradictionFlag>none</contradictionFlag>

- **Spatial/Morphological Validation:**  
  The study did not report spatial or morphological validation (e.g., immunostaining, in situ hybridization) specific to astrocyte subpopulations or activation states in Rett syndrome tissue.

- **Aging/Disease Trajectories:**  
  No evidence was presented for age- or disease-stage-dependent transitions in astrocyte states, nor for pseudotime trajectories indicating progressive astrocyte activation or dysfunction in Rett syndrome.

- **Modulators & Metrics:**  
  The study did not identify host or genetic factors (e.g., age, sex, X-inactivation skewing) that modulate astrocyte responses to MECP2 loss. The ratio of wild-type to mutant nuclei was approximately even, and no astrocyte-specific effects of X-inactivation skewing were observed.

- **Gene Regulatory Networks & Cell-Cell Communication:**  
  No astrocyte-specific gene regulatory networks or ligand-receptor interactions were highlighted as altered in Rett syndrome.

- **Genetic or Multi-omic Integration:**  
  The integration of DNA methylation and gene expression data, which revealed strong cell-type-specific effects in neurons, did not uncover analogous methylation-dependent regulatory changes in astrocytes.

Overall, the study’s data indicate that, in contrast to neurons, astrocytes in mosaic Rett syndrome brain tissue do not exhibit major cell-autonomous transcriptional changes or disease-associated subtypes detectable by snRNA-seq. <keyFinding priority='1'></keyFinding> <confidenceLevel>high</confidenceLevel> <contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
The lack of significant transcriptional response or emergence of disease-associated astrocyte subtypes in Rett syndrome suggests that astrocytes may not be primary drivers of pathology via cell-autonomous MECP2 loss, at least in the adult cortex. This finding implies that therapeutic strategies targeting astrocyte-intrinsic MECP2 function may have limited impact, and that astrocyte dysfunction in Rett syndrome, if present, may be secondary to neuronal pathology or mediated by non-transcriptional mechanisms. <keyFinding priority='2'></keyFinding> <confidenceLevel>medium</confidenceLevel> <contradictionFlag>none</contradictionFlag>
</clinical>
...
The absence of major disease-associated astrocyte subtypes or robust transcriptional changes in MECP2-mutant astrocytes, as revealed by single-nucleus RNA-seq, raises several open questions. It remains possible that astrocyte dysfunction in Rett syndrome is subtle, region-specific, or mediated by post-transcriptional, metabolic, or non-cell-autonomous mechanisms not captured by this approach. Future studies could employ higher-resolution spatial transcriptomics, proteomics, or functional assays to probe astrocyte contributions to Rett pathology, particularly during development or in other brain regions. The findings align with prior models suggesting a dominant neuronal-autonomous mechanism for MECP2-related dysfunction, but do not exclude more nuanced astrocyte roles. No explicit conflicts with previous astrocyte classification schemes or Rett syndrome models were discussed by the authors. <contradictionFlag>none</contradictionFlag>
...
# summary for Tuddenham 2024 (astrocytes)
...
<methods>
Single-cell RNA sequencing (scRNA-seq) of live, FACS-sorted CD45+ cells from 74 human donors (215,680 microglia) across 12 CNS regions and multiple neurological diseases. Cold, enzyme-free mechanical dissociation was used to preserve native transcriptomes. Major validation included in situ RNAscope–immunofluorescence and MERFISH spatial transcriptomics.  
Astrocytes were not the primary focus; their representation was limited to initial cell-type identification and exclusion from downstream microglial analyses.
</methods>

<findings>
**Cell Type Proportions:**  
Astrocytes were detected as a minor population among the CD45+ sorted cells, as expected given the myeloid enrichment strategy. They were identified in initial clustering (Extended Data Fig. 1), but not further analyzed. The vast majority of cells were microglia (~96%), with astrocytes and other glial/neuronal cells forming a small fraction.

**Differential Gene Expression & Subtype Identification:**  
The study did not perform detailed subclustering or transcriptomic analysis of astrocytes. Astrocytes were identified by canonical markers (e.g., GFAP) in the initial cell-type annotation step (Extended Data Fig. 1), confirming their presence but not characterizing their heterogeneity, disease associations, or functional states.

**Pathway Enrichment, Modulators, and Spatial Analysis:**  
No pathway enrichment, gene regulatory network, or cell-cell communication analyses were performed for astrocytes. No spatial or morphological validation of astrocyte subtypes was reported.  
Astrocytes were not included in the in situ validation panels or MERFISH spatial transcriptomics, which focused exclusively on microglial markers.

**Disease/Aging Trajectories and Genetic Integration:**  
No astrocyte-specific disease associations, aging trajectories, or genetic risk analyses were conducted. The study’s design and analytic pipeline were tailored to microglial diversity, and astrocytes were excluded from all downstream analyses after initial cell-type demarcation.

<keyFinding priority='3'>
Astrocytes were present as a minor contaminant in the CD45+ sorted population, confirmed by canonical marker expression, but were not analyzed for subtype diversity, disease association, or functional state.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
</findings>
...
<clinical>
No disease-specific roles, mechanistic insights, or biomarker/therapeutic implications for astrocytes are provided in this study. The resource is not suitable for astrocyte-focused analyses.
</clinical>

---

**Quick Reference (≈100 words):**  
Astrocytes were detected as a minor population in this cross-disease, multi-region scRNA-seq resource of live human brain CD45+ cells, but were not analyzed beyond initial cell-type identification. No astrocyte subtypes, marker genes, or disease associations were characterized. The study’s design and validation focused exclusively on microglia, with astrocytes excluded from all downstream analyses. Thus, this resource does not provide new insights into astrocyte heterogeneity or their roles in neurological disease.

---

**Detailed Summary (≈800–1000 words):**  
This landmark study by Tuddenham et al. (2024) presents a comprehensive single-cell RNA-seq resource profiling live human microglia across a wide spectrum of neurological diseases and CNS regions. The experimental design specifically targeted the isolation and characterization of microglia, using FACS sorting for CD45+ cells and cold, enzyme-free dissociation to preserve native transcriptomic states. While the initial cell suspensions inevitably included a small proportion of non-myeloid cells, including astrocytes, the analytic focus was strictly on microglial heterogeneity.

Astrocytes were identified in the initial clustering of all CD45+ cells, using canonical markers such as GFAP, SNAP25, and OLIG2 to distinguish non-immune (astrocyte, neuronal, oligodendrocyte) populations from microglia, monocytes, and adaptive immune cells (Extended Data Fig. 1). The authors report that astrocytes and other glial/neuronal cells comprised only a minor fraction of the sorted population, with microglia representing the overwhelming majority (~96%). This is consistent with the expected enrichment for myeloid cells in CD45+ FACS-sorted brain tissue.

After this initial cell-type demarcation, astrocytes were excluded from all further analyses. The study did not perform subclustering, differential gene expression, or pathway enrichment analyses for astrocytes. No astrocyte subtypes or cell states were defined, and no disease- or region-specific changes in astrocyte proportions or transcriptomes were reported. The authors did not investigate astrocyte functional signatures, gene regulatory networks, or cell-cell communication involving astrocytes.

Spatial and morphological validation, including RNAscope–immunofluorescence and MERFISH, was performed exclusively for microglial markers and subtypes. Astrocytes were not included in these validation panels, nor were they analyzed for spatial distribution or morphological features.

No analyses of astrocyte associations with disease status, pathology (e.g., amyloid, tau), clinical variables, or genetic risk factors were conducted. The study’s cross-sectional design and analytic pipeline were tailored to microglial diversity, and astrocytes were not considered in disease trajectory or genetic integration analyses.

The authors explicitly state that their resource is intended as a reference for microglial heterogeneity and as a tool for annotating microglial states in model systems and chemical perturbation screens. Astrocytes are not discussed in the context of disease mechanisms, therapeutic targeting, or biomarker development.
...
In summary, while astrocytes were detected in the initial cell-type annotation, this study provides no new data or insights into astrocyte biology in the context of neurological disease. The resource is not suitable for astrocyte-focused analyses.

---

**Research Implications (≈100–200 words):**  
This cross-disease, multi-region single-cell resource is a major advance for the study of human microglial heterogeneity, but it does not address astrocyte diversity or function. The exclusion of astrocytes from all downstream analyses reflects both the myeloid enrichment strategy (CD45+ FACS sorting) and the study’s explicit focus on microglia. As such, the dataset cannot be used to investigate astrocyte subtypes, disease associations, or functional states. Researchers interested in astrocyte biology in neurological disease will need to turn to other resources—ideally those using unbiased or astrocyte-enriching isolation strategies and dedicated astrocyte-focused analyses. No conflicts or contradictions with prior astrocyte literature are discussed, as astrocytes were not analyzed. The study highlights the importance of cell-type-specific design in single-cell studies and the need for complementary resources to address astrocyte heterogeneity in human brain disease.

---

**Summary Table of Tag Usage:**  
- <keyFinding priority='3'>Astrocytes present but not analyzed</keyFinding>
- <confidenceLevel>high</confidenceLevel>
- <contradictionFlag>none</contradictionFlag>
...
# summary for Zhang 2024 (astrocytes)

<metadata>
Zhang et al., 2024, Journal of Neuroinflammation.  
Disease focus: Perihematomal edema (PHE) following intracerebral hemorrhage (ICH).
</metadata>

<methods>
Single-cell RNA sequencing (scRNA-seq) was performed on perihematomal edematous tissue from 9 ICH patients, sampled at three time points post-ICH (0–6h, 6–24h, 24–48h). Cell type identification was based on canonical marker genes. Immunofluorescence was used for spatial validation of selected findings.
</methods>
...
Astrocytes in human perihematomal edema (PHE) after ICH were identified as a distinct population by scRNA-seq, defined by high expression of AQP4, ATP1B2, and ALDH1L1. No further astrocyte subtypes or disease-associated states were reported, and their proportion remained stable across PHE progression. No major genetic or demographic modulators were identified for astrocytes in this study.
...
<findings>
Astrocytes were robustly identified in the single-cell transcriptomic landscape of human PHE tissue following ICH, using canonical markers AQP4, ATP1B2, and ALDH1L1. These markers were highly and specifically expressed in clusters 8 and 16 (see Figure 1E), confirming the presence of astrocytes among the major cell types in the perihematomal region. <keyFinding priority='2'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag>

**Cell Type Proportions:**  
Astrocytes were present at all three sampled time points (G1: 0–6h, G2: 6–24h, G3: 24–48h post-ICH). The proportion of astrocytes among total cells remained relatively stable across these stages, with no statistically significant expansion or depletion reported (see Figure 1D). <keyFinding priority='2'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag> The authors did not highlight any dynamic changes in astrocyte abundance during PHE progression.

**Subtype Identification & Characterization:**  
Unlike microglia and neutrophils, which were further subdivided into multiple transcriptionally distinct subclusters, astrocytes were not reported to exhibit further heterogeneity or disease-associated subtypes in this dataset. The study did not identify or annotate reactive, proliferative, or otherwise specialized astrocyte states. The astrocyte clusters were defined solely by the expression of the above canonical markers, and no additional marker genes or functional signatures were described. <keyFinding priority='2'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag>

**Differential Gene Expression & Pathway Enrichment:**  
No significant differential gene expression or pathway enrichment analyses were reported for astrocytes. The authors did not discuss up- or down-regulation of specific genes, nor did they identify any astrocyte-specific pathways altered in PHE tissue. <keyFinding priority='3'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag>

**Spatial/Morphological Validation:**  
No astrocyte-specific immunofluorescence or spatial validation was performed. The spatial and morphological analyses focused on microglia, monocytes, and their interactions.

**Modulators & Metrics:**  
No evidence was presented for modulation of astrocyte states or abundance by host factors (age, sex, hypertension), genetic risk alleles, or clinical variables. The study cohort was relatively homogeneous (all hypertensive, basal ganglia ICH), and no genotype-phenotype associations were explored for astrocytes.

**Cell-Cell Communication & Regulatory Networks:**  
The cell-cell communication analyses (e.g., SPP1/osteopontin signaling) and transcription factor regulatory network (SCENIC) analyses were focused on microglia and neutrophils. Astrocytes were not implicated as major sources or targets in these signaling networks, nor were astrocyte-specific regulons highlighted.

**Aging/Disease Trajectories:**  
No pseudotime or trajectory analyses were performed for astrocytes. The temporal evolution of astrocyte states was not addressed.

**Genetic or Multi-omic Integration:**  
No eQTL or multi-omic integration was performed for astrocytes.

**Summary:**  
Overall, astrocytes were present as a transcriptionally defined, relatively homogeneous population in human PHE tissue after ICH, with no evidence for disease-associated subtypes, dynamic changes, or functional specialization within the first 48 hours post-ICH. <keyFinding priority='2'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag>
</findings>

<clinical>
Astrocytes were not implicated as major drivers or modulators of PHE pathophysiology in this study. The absence of reactive or disease-associated astrocyte subtypes suggests that, within the first 48 hours after ICH, astrocytes may play a relatively passive or homeostatic role in the perihematomal environment, at least at the transcriptional level detectable by scRNA-seq. No mechanistic or therapeutic implications for astrocytes were proposed. <keyFinding priority='2'><confidenceLevel>high</confidenceLevel><contradictionFlag>none</contradictionFlag>
</clinical>
...
The lack of astrocyte heterogeneity or disease-associated states in this study contrasts with findings from other neurological disorders (e.g., Alzheimer’s, multiple sclerosis), where reactive or neurotoxic astrocyte subtypes have been described. This may reflect a true absence of early astrocyte activation in human PHE, or could be due to technical limitations (e.g., sampling window, tissue dissociation bias, or sequencing depth). The study does not reference or discuss this potential discrepancy. <contradictionFlag>none</contradictionFlag>

Open questions include whether astrocyte reactivity emerges at later stages of PHE, whether spatially restricted or morphologically distinct astrocyte states exist but were not captured, and how astrocyte-microglia or astrocyte-neutrophil interactions might contribute to edema resolution or secondary injury. Future studies with larger cohorts, extended time points, and spatial transcriptomics may be needed to resolve these issues and to determine whether astrocyte subtypes play a more prominent role in PHE pathogenesis or recovery.

---

**Summary Table of Astrocyte Findings in Zhang et al. (2024):**

| Subtype/Cluster | Marker Genes         | Functional Signature | Disease Association | Proportion Change | Spatial/Morph Validation |
|-----------------|---------------------|---------------------|--------------------|-------------------|-------------------------|
| Astrocyte (8,16)| AQP4, ATP1B2, ALDH1L1| Not specified       | None reported      | Stable            | None                    |

---

**Overall, this study provides a baseline transcriptional profile for astrocytes in early human PHE, but does not identify heterogeneity or disease-associated states for this cell type.**
...
# summary for Zou 2024 (astrocytes)

**Quick Reference (≈100 words)**  
This study (Zou et al., 2024, *Pharmacological Research*) used single-cell and spatial transcriptomics to profile Alzheimer’s disease (AD) brains and identified 19 major cell types, including astrocytes. Astrocytes (Ast) were robustly detected but did **not** display major disease-associated subtypes or dramatic transcriptional shifts compared to neurons and microglia. The most critical findings center on microglia-neuron crosstalk and mitophagy regulation, with astrocytes remaining largely homeostatic across AD progression. No strong genetic, demographic, or pathological drivers of astrocyte heterogeneity or activation were reported in this dataset.
...
<metadata>
- **Citation**: Zou D, Huang X, Lan Y, Pan M, Xie J, et al. (2024). Single-cell and spatial transcriptomics reveals that PTPRG activates the m6A methyltransferase VIRMA to block mitophagy-mediated neuronal death in Alzheimer’s disease. *Pharmacological Research*, 201:107098.
- **Disease focus**: Alzheimer’s disease (AD)
</metadata>

<methods>
This study integrated single-cell RNA sequencing (scRNA-seq) from 85 AD and 83 control human samples (covering multiple cortical and subcortical regions, plus peripheral blood mononuclear cells) with spatial transcriptomics from coronal brain sections of AD model mice (AppNL-G-F) and controls. Cell types were annotated using canonical markers, and subclustering was performed for major populations. Validation included immunostaining and immunoprecipitation in wild-type and 5×FAD mice.
</methods>

<findings>
Astrocytes (Ast) were among the 19 major cell types robustly identified in the single-cell atlas of the human and mouse AD brain. The initial UMAP and marker gene analyses (Fig. 1B–C) confirmed the presence of astrocytes using canonical markers (not explicitly listed in the main text, but likely including GFAP, AQP4, SLC1A2, etc., per CellMarker and standard practice).

**Cell Type Proportions:**  
Astrocytes were consistently detected in both AD and control brains, but the study does not report significant quantitative changes in astrocyte abundance or major shifts in their proportion relative to other cell types. The volcano plots and spatial transcriptomics (Fig. 1D–F) highlight mitochondrial gene dysregulation primarily in neurons, with no mention of astrocyte-specific changes.

**Differential Gene Expression:**  
The main differentially expressed genes (DEGs) and pathway alterations described in the paper are centered on neuronal and microglial populations. The authors do not report astrocyte-specific DEGs or highlight any astrocyte subpopulations with disease-associated transcriptional signatures. The global DEG analysis (Fig. 1D) does not single out astrocytes for notable mitochondrial or stress pathway dysregulation.

**Pathway Enrichment:**  
Pathway analyses focus on mitophagy, cell death, and metabolic reprogramming in neurons, with microglial involvement in intercellular signaling. There is no evidence presented for astrocyte-specific pathway enrichment or activation of inflammatory, metabolic, or neuroprotective programs in AD.

**Cell Subtype Identification & Characterization:**  
Astrocytes are treated as a single, relatively homogeneous population in this study. The authors do not report the identification of distinct astrocyte subtypes or states (e.g., A1/A2, reactive, disease-associated astrocytes) in their clustering or spatial analyses. No marker gene sets or functional annotations are provided for astrocyte subclusters, and no disease-associated astrocyte states are described.

**Modulators & Metrics:**  
The study does not report any host or genetic factors (age, sex, APOE genotype, GWAS variants) that modulate astrocyte abundance, activation, or transcriptional state. Quantitative activation or reactivity scores for astrocytes are not discussed.

**Gene Regulatory Networks, Cell-Cell Communication, Spatial Analysis:**  
The paper’s major mechanistic focus is on microglia-neuron crosstalk (PTPRG–CNTN4 axis) and the regulation of neuronal mitophagy via VIRMA and PRKN. Astrocytes are not implicated in these ligand-receptor interactions, nor are they highlighted in spatial transcriptomic validation or cell-cell communication analyses.

**Aging/Disease Trajectories:**  
Pseudotime and trajectory analyses are performed for neuronal and microglial subpopulations, revealing disease-stage transitions and functional reprogramming. Astrocytes are not included in these trajectory models, and no evidence is presented for astrocyte state transitions during AD progression.

**Genetic or Multi-omic Integration:**  
No eQTL, GWAS, or multi-omic integration findings are reported for astrocytes in this study.

<keyFinding priority='3'>
Astrocytes are present and transcriptionally stable across AD and control brains, with no evidence for major disease-associated subtypes or activation states in this dataset.
</keyFinding>
<confidenceLevel>high</confidenceLevel>
<contradictionFlag>none</contradictionFlag>
...
<clinical>
The study does not provide evidence for a direct or disease-specific role of astrocytes in AD pathogenesis within the analyzed datasets. Mechanistic insights and therapeutic implications are centered on microglia-neuron interactions and neuronal mitophagy, with astrocytes remaining largely homeostatic and not implicated as drivers or modulators of pathology in this work.
</clinical>
...
This comprehensive single-cell and spatial transcriptomic analysis of AD brains finds astrocytes to be a transcriptionally stable and relatively homogeneous population, with no evidence for disease-associated subtypes or activation states. This contrasts with some prior studies that have reported reactive or disease-associated astrocyte states (e.g., A1/A2, DAA) in AD and other neurodegenerative conditions. The absence of astrocyte heterogeneity or activation in this dataset may reflect differences in tissue sampling, sequencing depth, or analytical focus, as the authors prioritized neuronal and microglial mechanisms. The findings suggest that, at least in the sampled regions and disease stages, astrocytes do not undergo major transcriptional reprogramming in AD, and their role may be secondary to microglia-neuron crosstalk and neuronal mitophagy failure. Future studies should address whether more subtle or region-specific astrocyte changes occur, or whether astrocyte heterogeneity emerges at later disease stages or in response to specific pathological triggers. The lack of astrocyte activation in this study raises important questions about the context-dependence of astrocyte responses in AD and highlights the need for further multi-omic and spatially resolved investigations.

<contradictionFlag>details</contradictionFlag>
The authors do not explicitly discuss conflicts with prior reports of disease-associated astrocyte states, but their findings diverge from some recent single-nucleus RNA-seq studies that have identified reactive astrocyte subtypes in AD. This discrepancy is not addressed in the text.

---

**Summary Table of Astrocyte Findings in This Study**

| Aspect                | Finding in This Study                                      |
|-----------------------|-----------------------------------------------------------|
| Subtypes/states       | No distinct subtypes or disease-associated states         |
| Marker genes          | Not specified beyond canonical astrocyte markers          |
| Proportion            | Stable across AD and control brains                       |
| DEG/pathways          | No major astrocyte-specific changes reported              |
| Modulators            | No genetic/demographic/pathological drivers identified    |
| Spatial/morphology    | No spatially restricted astrocyte activation observed     |
| Clinical relevance    | Not implicated as AD drivers in this dataset              |
